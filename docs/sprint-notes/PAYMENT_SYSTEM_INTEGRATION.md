...
describe('PaymentProcessor', () => {
  ...
  it('should reject refund on non-completed transaction', async () => {
    ...
    expect(() => processor.refundPayment({ transactionId: txn.id }))
      .toThrow('Cannot refund pending transaction');
  });
...
processor.log('info', 'Creating payment intent', { shopId, amount, methodType });
