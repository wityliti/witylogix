...
| WIT-544 | feat/WIT-544-customers-design-tokens | customers/page.tsx (11 hex), customers/segments/page.tsx (9 hex), customers/components/customers-map-view.tsx (5 hex): 25 hardcoded hex CSS values → WL design tokens (bg-wl-bg-root, bg-wl-bg-surface, bg-wl-bg-elevated, bg-wl-bg-overlay, border-wl-border-default, border-wl-border-strong, text-wl-text-primary/secondary/tertiary) | no new endpoints | 3 files, 25 CSS signals → 0 | 2026-06-14 |
