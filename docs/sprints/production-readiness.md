...
| ✅ Supply Chain | supply-chain/orders | No | WIT-351 — WAVE_PLANS/BATCH_PICKING/RETURN_QUEUE removed; /api/v4/supply-chain/waves + /batches (new), /api/v4/returns (reused) |
...
| ✅ Admin (audit) | admin/audit | No | WIT-351 — DEMO_DATA removed, audit trail on real /api/v4/audit endpoint |
| ⬜ Admin (activity, users, queues, workflows) | admin/activity, admin/users, admin/queues, admin/workflows | No | Lower priority |
