#!/usr/bin/env bash
# Production smoke tests for the Witylogix Customer Portal
#
# Usage:
#   BASE_URL=https://portal.example.com ./tests/smoke/customer-portal.sh
#
# Exit codes:
#   0 - All checks passed
...
echo "--- Customer Portal smoke tests ($BASE_URL) ---"

check_http "Homepage loads (HTTP 200)" "$BASE_URL/" 200 "<html"
