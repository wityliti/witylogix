...
describe('Login Flow E2E', () => {
  ...
  describe('Successful Login', () => {
    ...
    it('should require MFA when enabled', async () => {
      ...
      await helper.navigateToLogin();
      await helper.fillLoginForm('user-with-mfa@example.com', 'SecurePassword123');
      await helper.submitLogin();
...
describe('Password Reset E2E', () => {
  ...
  describe('Reset Flow', () => {
    ...
    it('should reject expired token', async () => {
      ...
      await page.goto('http://localhost:3000/reset-password?token=expired-token');
...
describe('Magic Link E2E', () => {
  ...
  describe('Magic Link Flow', () => {
    ...
    it('should authenticate with valid link', async () => {
      ...
      await page.goto('http://localhost:3000/login?magic-link-token=valid-token');
