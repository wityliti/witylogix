...
test.describe('Integrations Overview', () => {
  ...
  test('should display integration health score or provider grid', async ({ adminPage }) => {
    await adminPage.goto('/integrations', { waitUntil: 'networkidle' });
...
test.describe('Connected Integrations', () => {
  test('should load connected integrations page', async ({ adminPage }) => {
    await adminPage.goto('/integrations/connected', { waitUntil: 'networkidle' });
  ...
  test('should display connected integrations list or empty state', async ({ adminPage }) => {
    await adminPage.goto('/integrations/connected', { waitUntil: 'networkidle' });
    await adminPage.waitForLoadState('networkidle');
  ...
  test('should support searching connected integrations', async ({ adminPage }) => {
    await adminPage.goto('/integrations/connected', { waitUntil: 'networkidle' });
    await adminPage.waitForLoadState('networkidle');
  ...
  test('should navigate to connected provider detail', async ({ adminPage }) => {
    await adminPage.goto('/integrations/connected', { waitUntil: 'networkidle' });
    await adminPage.waitForLoadState('networkidle');
...
test.describe('Integration Credentials', () => {
  test('should load credentials page', async ({ adminPage }) => {
    await adminPage.goto('/integrations/credentials', { waitUntil: 'networkidle' });
  ...
  test('should display credentials list or empty state', async ({ adminPage }) => {
    await adminPage.goto('/integrations/credentials', { waitUntil: 'networkidle' });
    await adminPage.waitForLoadState('networkidle');
...
test.describe('E-commerce Integrations', () => {
  test('should load e-commerce integrations page', async ({ adminPage }) => {
    await adminPage.goto('/integrations/ecommerce', { waitUntil: 'networkidle' });
  ...
  test('should display e-commerce integration options', async ({ adminPage }) => {
    await adminPage.goto('/integrations/ecommerce', { waitUntil: 'networkidle' });
    await adminPage.waitForLoadState('networkidle');
  ...
  test('should show Shopify integration option', async ({ adminPage }) => {
    ...
    const shopifyOption = adminPage.locator('text=Shopify, [alt="Shopify"], [data-testid="shopify-card"]');
    const isVisible = await shopifyOption.first().isVisible().catch(() => false);
...
test.describe('Webhook Integrations', () => {
  test('should load webhook integrations page', async ({ adminPage }) => {
    await adminPage.goto('/integrations/webhooks', { waitUntil: 'networkidle' });
  ...
  test('should display webhook integration list or empty state', async ({ adminPage }) => {
    await adminPage.goto('/integrations/webhooks', { waitUntil: 'networkidle' });
    await adminPage.waitForLoadState('networkidle');
