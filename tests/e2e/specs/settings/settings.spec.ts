...
test.describe("Settings Overview", () => {
  ...
  test("should display settings navigation cards", async ({ adminPage }) => {
    ...
    const cards = adminPage.locator(
      'a[href*="/settings/"], [data-testid="settings-card"]',
    );
...
test.describe("General Settings", () => {
  ...
  test("should display settings form fields", async ({ adminPage }) => {
    ...
    const formElement = adminPage.locator(
      'form, [data-testid="settings-form"], input, select',
    );
    const hasForm = await formElement
      .first()
      .isVisible()
      .catch(() => false);
...
test.describe("Team Settings", () => {
  ...
  test("should open invite member form", async ({ adminPage }) => {
    ...
    if (isVisible) {
      ...
      const hasInput = await emailInput
        .first()
        .isVisible()
        .catch(() => false);
...
test.describe("Billing Settings", () => {
  ...
  test("should display billing plan information", async ({ adminPage }) => {
    ...
    const isVisible = await planInfo
      .first()
      .isVisible()
      .catch(() => false);
    expect(isVisible).toBeTruthy();
...
test.describe("Notification Settings", () => {
  ...
  test("should display notification preference toggles", async ({
    adminPage,
  }) => {
    await adminPage.goto("/settings/notifications", {
      waitUntil: "networkidle",
  ...
  test("should load WhatsApp config page", async ({ adminPage }) => {
    await adminPage.goto("/settings/notifications/whatsapp", {
      waitUntil: "networkidle",
    });
...
test.describe("Webhooks Settings", () => {
  ...
  test("should load webhook test page", async ({ adminPage }) => {
    await adminPage.goto("/settings/webhooks/test", {
      waitUntil: "networkidle",
    });
...
test.describe("Auth Providers Settings", () => {
  test("should load auth providers page", async ({ adminPage }) => {
    await adminPage.goto("/settings/auth-providers", {
      waitUntil: "networkidle",
    });
