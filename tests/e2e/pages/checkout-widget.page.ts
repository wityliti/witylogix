...
export class CheckoutWidgetPage {
  ...
  constructor(page: Page) {
    this.page = page;
    this.checkoutWidget = page.locator('[data-testid="checkout-widget"], [data-testid="checkout-container"]');
    this.addressInput = page.locator('[data-testid="address-input"], input[placeholder*="address" i]');
    this.addressSuggestions = page.locator('[data-testid="address-suggestions"], [role="listbox"]');
    this.zipcodeInput = page.locator('[data-testid="zipcode-input"], input[placeholder*="zip" i]');
    this.zipcodeError = page.locator('[data-testid="zipcode-error"], [data-testid="zone-error"]');
    this.zoneIndicator = page.locator('[data-testid="zone-indicator"], [data-testid="delivery-zone"]');
    this.deliveryMethodSelect = page.locator('[data-testid="delivery-method"], select, [role="combobox"]');
    this.deliveryMethodOptions = page.locator('[data-testid="delivery-option"], [role="option"]');
    this.dateSelector = page.locator('[data-testid="date-selector"], [data-testid="delivery-date"]');
    this.datePicker = page.locator('[data-testid="date-picker"], [role="dialog"]');
    this.calendarDays = page.locator('[data-testid="calendar-day"], [data-testid="calendar-date"]');
    this.blackoutDates = page.locator('[data-testid="blackout-date"], [disabled][data-date]');
    this.timeSlotContainer = page.locator('[data-testid="time-slots"], [data-testid="slot-container"]');
    this.timeSlots = page.locator('[data-testid="time-slot"], [data-testid="slot"]');
    this.capacityIndicator = page.locator('[data-testid="capacity-indicator"], [data-testid="slot-capacity"]');
    this.deliveryRateDisplay = page.locator('[data-testid="delivery-rate"], [data-testid="rate-amount"]');
    this.orderSummary = page.locator('[data-testid="order-summary"], [data-testid="summary"]');
    this.subtotalPrice = page.locator('[data-testid="subtotal"], [data-testid="subtotal-price"]');
    this.deliveryFee = page.locator('[data-testid="delivery-fee"], [data-testid="delivery-charge"]');
    this.totalPrice = page.locator('[data-testid="total-price"], [data-testid="order-total"]');
    this.completeCheckoutButton = page.locator('[data-testid="complete-checkout"], button:has-text("Complete")', page.locator('button:has-text("Checkout")'));
    ...
    this.successMessage = page.locator('[data-testid="success-message"], [data-testid="confirmation"]');
    this.loadingIndicator = page.locator('[data-testid="loading"], [role="progressbar"]');
    this.cutoffWarning = page.locator('[data-testid="cutoff-warning"], [data-testid="deadline-warning"]');
  }
  ...
  async enterAddress(address: string): Promise<void> {
    ...
    try {
      ...
      const firstSuggestion = this.page.locator('[data-testid="address-suggestions"] [role="option"]').first();
   ...
   */
  async selectDeliveryMethod(method: 'standard' | 'express' | 'sameday'): Promise<void> {
    const methodLabel = {
      standard: 'Standard',
      express: 'Express',
      sameday: 'Same Day',
  ...
  async selectTimeSlot(time: string): Promise<void> {
    const slot = this.page.locator(`[data-testid="time-slot"]:has-text("${time}")`);
   ...
   */
  async getCapacityIndicator(slotId: string): Promise<{ current: number; max: number; percentage: number }> {
    const indicator = this.page.locator(`[data-testid="capacity-indicator"][data-slot-id="${slotId}"]`);
  ...
  async getOrderSummary(): Promise<{
    ...
    const address = await this.page.locator('[data-testid="summary-address"]').textContent();
    const date = await this.page.locator('[data-testid="summary-date"]').textContent();
    const time = await this.page.locator('[data-testid="summary-time"]').textContent();
  ...
  async isOutsideDeliveryZone(): Promise<boolean> {
    ...
    return errorVisible || errorText.includes('outside') || errorText.includes('zone');
  }
