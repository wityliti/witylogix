...
describe('OnfleetAdapter', () => {
  ...
  describe('Delivery Creation', () => {
    it('should create delivery with all required fields', async () => {
      const mockResponse = new Response(JSON.stringify({ data: mockOnfleetTask }), {
        status: 201,
      });
  ...
  describe('Get Quote', () => {
    ...
    it('should calculate delivery duration from quote', () => {
      const duration = mockOnfleetQuote.estimatedCompletionTime - mockOnfleetQuote.estimatedPickupTime;
  ...
  describe('Task Status Transitions', () => {
    ...
    it('should preserve task history through status changes', () => {
      ...
      expect(task.trackingURL).toBe('https://onfleet.com/tasks/task_onfleet_123/track');
  ...
  describe('Cancel Delivery', () => {
    it('should cancel delivery successfully', async () => {
      const mockResponse = new Response(JSON.stringify({ data: mockOnfleetTaskCancelled }), {
        status: 200,
      });
      mockFetch.mockResolvedValue(mockResponse);
  ...
  describe('Webhook Payload Handling', () => {
    ...
    it('should extract task update data from webhook', () => {
      ...
      expect(data.completionDetails?.notes).toBe('Delivery completed successfully');
    });
  ...
  describe('Task Without Estimates', () => {
    it('should handle task without time estimates', () => {
      expect(mockOnfleetTaskWithoutEstimates.estimatedServiceTime).toBeUndefined();
      expect(mockOnfleetTaskWithoutEstimates.estimatedArrivalTime).toBeUndefined();
    });
  ...
  describe('Service Time', () => {
    ...
    it('should calculate service window from estimates', () => {
      const serviceWindow = mockOnfleetTask.estimatedCompletionTime -
