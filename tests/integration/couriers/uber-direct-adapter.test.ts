...
describe("UberDirectAdapter", () => {
  ...
  describe("Delivery Status with Courier Location", () => {
    ...
    it("should update status during transit", () => {
      expect(mockUberDirectDeliveryInTransit.status).toBe(
        "en_route_to_dropoff",
      );
      expect(mockUberDirectDeliveryInTransit.updated_at).toBe(
        "2024-03-11T14:10:00Z",
      );
    });
    ...
    it("should track assigned couriers count", () => {
      expect(mockUberDirectDelivery.driver_assignments.assigned_couriers).toBe(
        1,
      );
    });
    ...
    it("should handle delivery without assigned driver", () => {
      expect(
        mockUberDirectQuoteWithoutDriver.driver_assignments.assigned_couriers,
      ).toBe(0);
    });
  });
  ...
  describe("Delivery Completion", () => {
    ...
    it("should preserve delivery metadata when completed", () => {
      expect(mockUberDirectDeliveryCompleted.order_reference_id).toBe(
        "order_003",
      );
      expect(mockUberDirectDeliveryCompleted.delivery_id).toBe(
        "delivery_uber_789",
      );
    });
  });
  ...
  describe("Cancellation with Fee", () => {
    ...
    it("should track cancellation timestamp", () => {
      expect(mockUberDirectDeliveryCancelled.updated_at).toBe(
  ...
  describe("Webhook Verification", () => {
    it("should parse webhook payload", () => {
      expect(mockUberDirectWebhookPayload.delivery_id).toBe(
        "delivery_uber_789",
      );
      expect(mockUberDirectWebhookPayload.event_type).toBe(
  ...
  describe("Pickup and Dropoff", () => {
    ...
    it("should include scheduled times", () => {
      expect(mockUberDirectDelivery.pickup.scheduled_time).toBe(
        "2024-03-11T14:00:00Z",
      );
      expect(mockUberDirectDelivery.dropoff.scheduled_time).toBe(
        "2024-03-11T14:30:00Z",
      );
    });
  });
  ...
  describe("Timestamp Tracking", () => {
    ...
    it("should update timestamp on status changes", () => {
      ...
      expect(mockUberDirectDeliveryCompleted.updated_at).toBe(
        "2024-03-11T14:30:00Z",
      );
    });
  });
