...
describe('CourierDispatcher', () => {
  ...
  describe('Webhook Routing', () => {
    ...
    it('should handle webhook payload routing', () => {
      ...
      const handler = webhookHandlers[incomingWebhook.source as keyof typeof webhookHandlers];
  ...
  describe('Cost Analysis', () => {
    ...
    it('should identify cost savings opportunity', () => {
      ...
      const savings = (onfleetQuote?.estimatedCost ?? 0) - (stuartQuote?.estimatedCost ?? 0);
