...
describe('SamsaraClient', () => {
  ...
  describe('Authentication', () => {
    it('should authenticate successfully with valid API token', async () => {
      const mockResponse = new Response(JSON.stringify(mockSamsaraAuthSuccessResponse), {
        status: 200,
      });
  ...
  describe('Get Vehicles', () => {
    it('should fetch all vehicles with pagination', async () => {
      const mockResponse = new Response(JSON.stringify(mockSamsaraVehiclesResponse), {
        status: 200,
      });
      mockFetch.mockResolvedValue(mockResponse);
    ...
    it('should return empty array when no vehicles found', async () => {
      const mockResponse = new Response(JSON.stringify(mockEmptyVehiclesResponse), {
        status: 200,
      });
      mockFetch.mockResolvedValue(mockResponse);
  ...
  describe('Get Vehicle Position', () => {
    it('should fetch current position with GPS data', async () => {
      const mockResponse = new Response(JSON.stringify(mockSamsaraLocationResponse), {
        status: 200,
      });
      mockFetch.mockResolvedValue(mockResponse);
    ...
    it('should retry on rate limit for position request', async () => {
      ...
      const successResponse = new Response(JSON.stringify(mockSamsaraLocationResponse), {
        status: 200,
      });
  ...
  describe('Get Vehicle Diagnostics', () => {
    it('should fetch diagnostics with fault codes', async () => {
      const mockResponse = new Response(JSON.stringify(mockSamsaraDiagnosticsResponse), {
        status: 200,
      });
      mockFetch.mockResolvedValue(mockResponse);
    ...
    it('should map fault code severity correctly', async () => {
      ...
      diagnostics.faultCodes.forEach((code) => {
        expect(['info', 'warning', 'error', 'critical']).toContain(code.severity);
      });
    });
  ...
  describe('Get Driver Behavior Events', () => {
    it('should fetch behavior events with correct mapping', async () => {
      ...
      const events = await client.getDriverBehaviorEvents('driver_456', dateRange);
    ...
    it('should return empty array when no events found', async () => {
      const mockResponse = new Response(JSON.stringify(mockEmptyEventsResponse), {
        status: 200,
      });
      mockFetch.mockResolvedValue(mockResponse);
  ...
  describe('Get Fuel Level', () => {
    it('should fetch fuel level with percentage', async () => {
      const mockResponse = new Response(JSON.stringify(mockSamsaraFuelResponse), {
        status: 200,
      });
      mockFetch.mockResolvedValue(mockResponse);
    ...
    it('should retry on rate limit for fuel request', async () => {
      ...
      const successResponse = new Response(JSON.stringify(mockSamsaraFuelResponse), {
        status: 200,
      });
  ...
  describe('Webhook Management', () => {
    it('should register webhook subscription', async () => {
      const mockResponse = new Response(JSON.stringify(mockSamsaraWebhookResponse), {
        status: 201,
      });
      mockFetch.mockResolvedValue(mockResponse);
  ...
  describe('Error Handling', () => {
    ...
    it('should retry on transient errors', async () => {
      ...
      const successResponse = new Response(JSON.stringify(mockSamsaraVehiclesResponse), {
        status: 200,
      });
