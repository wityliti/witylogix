...
import { createMockContact, createMockDeal } from '../fixtures/crm-accounting-fixtures.js';
...
describe('CRM Conflict Resolution', () => {
  ...
  describe('TIMESTAMP_WINS Strategy', () => {
    it('should select most recent local change', () => {
      ...
      expect(localTimestamp.getTime()).toBeGreaterThan(remoteTimestamp.getTime());
    });
  ...
  describe('SOURCE_OF_TRUTH Strategy', () => {
    it('should always use designated source of truth', () => {
      ...
      const conflict: SyncConflict = {
        ...
        recordType: 'deal',
        field: 'amount',
        localValue: 5000.00, // HubSpot
        remoteValue: 5500.00, // Salesforce
        localTimestamp: new Date('2024-03-15T14:30:00Z'),
        remoteTimestamp: new Date('2024-03-15T14:00:00Z'),
        strategy: 'SOURCE_OF_TRUTH',
        status: 'resolved',
        resolvedValue: 5500.00, // Salesforce is source of truth
      };

      expect(conflict.resolvedValue).toBe(5500.00);
    });
  ...
  describe('Concurrent Update Detection', () => {
    it('should detect concurrent updates to same field', () => {
      ...
      const isConcurrent = update1.timestamp.getTime() === update2.timestamp.getTime();
    ...
    it('should detect sequential updates', () => {
      ...
      const isSequential = update2Timestamp.getTime() > update1Timestamp.getTime();
    ...
    it('should flag conflicting concurrent updates', () => {
      ...
      const hasConflict =
        ...
        Math.abs(
          conflict.localTimestamp.getTime() - conflict.remoteTimestamp.getTime()
