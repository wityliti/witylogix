...
export const createEnvelopeFixture = (overrides?: Partial<EnvelopeFixture>): EnvelopeFixture => ({
...
export const createMultiSignerEnvelopeFixture = (overrides?: Partial<EnvelopeFixture>): EnvelopeFixture => ({
  id: `env_${Math.random().toString(36).substr(2, 9)}`,
...
export const createSentEnvelopeFixture = (overrides?: Partial<EnvelopeFixture>): EnvelopeFixture => ({
  id: `env_${Math.random().toString(36).substr(2, 9)}`,
...
export const createCompletedEnvelopeFixture = (overrides?: Partial<EnvelopeFixture>): EnvelopeFixture => ({
  id: `env_${Math.random().toString(36).substr(2, 9)}`,
...
export const createNdaTemplateFixture = (overrides?: Partial<TemplateFixture>): TemplateFixture => ({
  id: `tpl_${Math.random().toString(36).substr(2, 9)}`,
...
export const createContractTemplateFixture = (overrides?: Partial<TemplateFixture>): TemplateFixture => ({
  id: `tpl_${Math.random().toString(36).substr(2, 9)}`,
...
export const createSignerFixture = (overrides?: Partial<SignerFixture>): SignerFixture => ({
...
export const createApproverFixture = (overrides?: Partial<SignerFixture>): SignerFixture => ({
...
export const createCcSignerFixture = (overrides?: Partial<SignerFixture>): SignerFixture => ({
...
export const createSignatureFieldFixture = (overrides?: Partial<FieldFixture>): FieldFixture => ({
...
export const createInitialFieldFixture = (overrides?: Partial<FieldFixture>): FieldFixture => ({
  id: `field_${Math.random().toString(36).substr(2, 9)}`,
  type: 'initial',
  pageNumber: 1,
  xPosition: 300,
...
export const createDateFieldFixture = (overrides?: Partial<FieldFixture>): FieldFixture => ({
  id: `field_${Math.random().toString(36).substr(2, 9)}`,
  type: 'date',
  pageNumber: 1,
  xPosition: 400,
...
export const createTextFieldFixture = (overrides?: Partial<FieldFixture>): FieldFixture => ({
  id: `field_${Math.random().toString(36).substr(2, 9)}`,
  type: 'text',
  pageNumber: 1,
  xPosition: 150,
...
export const createAuditEventFixture = (overrides?: Partial<AuditEventFixture>): AuditEventFixture => ({
...
export const createEnvelopeCreatedEventFixture = (envelopeId: string): AuditEventFixture => ({
  envelopeId,
  eventType: 'envelope_created',
  timestamp: new Date(),
...
export const createEnvelopeSentEventFixture = (envelopeId: string): AuditEventFixture => ({
  envelopeId,
...
export const createSignatureEventFixture = (envelopeId: string, signer: string): AuditEventFixture => ({
  envelopeId,
...
export const createEnvelopeCompletedEventFixture = (envelopeId: string): AuditEventFixture => ({
  envelopeId,
