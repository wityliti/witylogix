...
export function createShopifyOrder(
...
export function createBigCommerceOrder(
  overrides?: Partial<PlatformOrder>,
): PlatformOrder {
  return {
...
export function createMagentoOrder(
  overrides?: Partial<PlatformOrder>,
): PlatformOrder {
  return {
...
export function createEtsyOrder(
  overrides?: Partial<PlatformOrder>,
): PlatformOrder {
  return {
...
export function createEBayOrder(
  overrides?: Partial<PlatformOrder>,
): PlatformOrder {
  return {
...
export function createFieldConflict(
  field: string,
  externalValue: any,
  internalValue: any,
): SyncConflict {
...
export function createStatusConflict(
...
export function createShopifyFieldMappings(): FieldMapping[] {
  return [
    createFieldMapping({
      externalField: "id",
      internalField: "externalOrderId",
      isRequired: true,
    }),
    createFieldMapping({
      externalField: "financial_status",
      internalField: "paymentStatus",
      isRequired: true,
    }),
    createFieldMapping({
      externalField: "fulfillment_status",
      internalField: "fulfillmentStatus",
      isRequired: false,
    }),
    createFieldMapping({
      externalField: "total_price",
      internalField: "total",
      isRequired: true,
    }),
    createFieldMapping({
