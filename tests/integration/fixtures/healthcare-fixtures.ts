...
export const createFemalePatientFixture = (
  overrides?: Partial<PatientFixture>,
): PatientFixture => ({
  mrn: `MRN${Math.floor(Math.random() * 1000000)}`,
  firstName: "Jane",
...
export const createPediatricPatientFixture = (
  overrides?: Partial<PatientFixture>,
): PatientFixture => ({
  mrn: `MRN${Math.floor(Math.random() * 1000000)}`,
  firstName: "Tommy",
...
export const createEncounterFixture = (
  patientId: string,
...
export const createEmergencyEncounterFixture = (
  patientId: string,
  overrides?: Partial<EncounterFixture>,
): EncounterFixture => ({
  patientId,
...
export const createHospitalizationFixture = (
  patientId: string,
  overrides?: Partial<EncounterFixture>,
): EncounterFixture => ({
  patientId,
...
export const createObservationFixture = (
  encounterId: string,
  overrides?: Partial<ObservationFixture>,
): ObservationFixture => ({
  encounterId,
  code: "9279-1",
...
export const createBloodPressureFixture = (
  encounterId: string,
  overrides?: Partial<ObservationFixture>,
): ObservationFixture => ({
  encounterId,
...
export const createTemperatureFixture = (
  encounterId: string,
  overrides?: Partial<ObservationFixture>,
): ObservationFixture => ({
  encounterId,
...
export const createLabResultFixture = (
  encounterId: string,
  overrides?: Partial<ObservationFixture>,
): ObservationFixture => ({
  encounterId,
...
export const createConditionFixture = (
  patientId: string,
  overrides?: Partial<ConditionFixture>,
): ConditionFixture => ({
  patientId,
  code: "I10",
...
export const createDiabetesFixture = (
  patientId: string,
  overrides?: Partial<ConditionFixture>,
): ConditionFixture => ({
  patientId,
...
export const createAsthmaFixture = (
  patientId: string,
  overrides?: Partial<ConditionFixture>,
): ConditionFixture => ({
  patientId,
...
export const createMedicationFixture = (
  overrides?: Partial<MedicationFixture>,
): MedicationFixture => ({
  name: "Lisinopril",
  dosage: "10 mg",
...
export const createAntibioticFixture = (
  overrides?: Partial<MedicationFixture>,
): MedicationFixture => ({
  name: "Amoxicillin",
  dosage: "500 mg",
...
export const createInsulinFixture = (
  overrides?: Partial<MedicationFixture>,
): MedicationFixture => ({
...
export const createAdtA01MessageFixture = (
  patientId: string,
  mrn: string,
): string => {
