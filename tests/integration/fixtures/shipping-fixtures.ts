...
export const mockLabel = {
  ...
  labelZpl: 'CT~~CD,~CC^~CT~^XA^MMC^PW812^LL0203^LS0^BY3,3,83^FT512,175^BCN,,Y,N^FD123456789US^FS^XZ',
  labelFormat: 'PDF',
  carrier: 'USPS',
  service: 'Priority Mail',
...
export const mockTrackingStatusNormalization = {
  carriers: {
    ...
    uberdirect: { status: 'en_route_to_destination', message: 'Going to delivery location' },
  },
  normalized: {
    status: 'IN_TRANSIT',
