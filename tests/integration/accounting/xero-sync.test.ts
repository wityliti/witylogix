...
describe("XeroSync", () => {
  ...
  describe("Idempotent Sync Operations", () => {
    ...
    it("should prevent double-posting of payments", () => {
      ...
      const uniquePayments = [
        ...new Map(payments.map((p) => [p.paymentID, p])).values(),
      ];
  ...
  describe("Error Handling", () => {
    it("should handle authorization errors", () => {
      ...
      expect(mockXeroUnauthorizedError.apiErrors[0].type).toBe(
    ...
    it("should handle validation errors", () => {
      ...
      expect(mockXeroValidationError.apiErrors[0].type).toBe(
        "ValidationException",
      );
      expect(mockXeroValidationError.apiErrors[0].message).toContain(
        "required",
      );
    });
    ...
    it("should handle rate limiting", () => {
      ...
      expect(mockXeroRateLimitError.apiErrors[0].type).toBe(
        "RateLimitException",
      );
    });
