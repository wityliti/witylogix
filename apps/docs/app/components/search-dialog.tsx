        ...
        <div className="max-h-[50vh] overflow-y-auto">
          {loading ? (
            <div className="flex flex-col items-center justify-center py-16 gap-3">
              ...
              <span className="text-sm text-[var(--sand-dim)]">
                Thinking...
              </span>
            </div>
          ) : error ? (
            ...
            <div className="p-5 space-y-5">
              ...
              <div>
                ...
                <p className="text-[var(--sand)] text-[15px] leading-relaxed whitespace-pre-wrap">
                  {result.answer}
                </p>
              </div>
              ...
              {result.citations.length > 0 && (
                <div>
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-xs font-semibold text-[var(--mint,#34d399)] uppercase tracking-wider">
                      Sources
                    </span>
                  </div>
                  <div className="grid gap-2">
                    {result.citations.map((c, idx) => (
                      ...
                      >
                        <div className="text-sm font-medium text-[var(--sand)] group-hover:text-[var(--teal)] transition-colors">
                          {c.title}
                        </div>
                        <div className="text-xs text-[var(--sand-dim)] mt-0.5">
                          {c.section}
                        </div>
                      </a>
                    ))}
              ...
              {result.followUpQuestions.length > 0 && (
                <div>
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-xs font-semibold text-[var(--sand-dim)] uppercase tracking-wider">
                      Related
                    </span>
                  </div>
        ...
        <div className="flex items-center justify-between px-5 py-2.5 border-t border-[var(--forge-border)] text-[11px] text-[var(--sand-dim)]">
          <div className="flex items-center gap-3">
            <span className="flex items-center gap-1">
              <kbd className="px-1 py-0.5 rounded border border-[var(--forge-border-light)] bg-[var(--forge-raised)] font-mono text-[10px]">
                ↵
              </kbd>
              Search
            </span>
