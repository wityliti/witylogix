...
export default function AuthProvidersIndex() {
 ...
 showToast(
 `${selectedProvider?.name} connection test successful!`,
 false
 );
 ...
 showToast(`${provider.name} set as default authentication provider!`, false);
 };
 ...
 const commonFields = () => (
 <>
 <TextField autoComplete="off" label="Configuration Name"
 value={config.name || ""}
 ...
 <BlockStack gap="400">
 {commonFields()}
 <TextField autoComplete="off" label="Domain"
 value={config.domain || ""}
 onChange={(value) => handleConfigChange("domain", value)}
 placeholder="your-domain.auth0.com"
 type="text"
 />
 <TextField autoComplete="off" label="Client ID"
...
/>
 <TextField autoComplete="off" label="API Audience"
 ...
 <BlockStack gap="400">
 {commonFields()}
 <TextField autoComplete="off" label="Publishable Key"
...
/>
 ...
 <BlockStack gap="400">
 {commonFields()}
 <TextField autoComplete="off" label="User Pool ID"
 ...
 <BlockStack gap="400">
 {commonFields()}
 <TextField autoComplete="off" label="Discovery URL"
 ...
 autoComplete="current-password"
/>
 <TextField autoComplete="off" label="Scopes"
 value={config.scopes || ""}
 ...
 <BlockStack gap="400">
 <Banner tone="info">
 Local authentication is always enabled by default. Users can manage
 their own passwords through the Witylogix dashboard.
 </Banner>
 </BlockStack>
 );
 }
 ...
 <Badge
 tone={provider.enabled ? "success" : "attention"}
 >
