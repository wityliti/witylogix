  ...
  return (
    <Page title="Setup Witylogix">
      <Layout>
        ...
        <Layout.Section>
          <Card>
            <div style={{ padding: "24px", display: "flex", justifyContent: "space-between", gap: "12px" }}>
              ...
              <Button variant="primary" onClick={handleNext} loading={fetcher.state === "submitting"}>
    ...
    <Card>
      <div style={{ padding: "48px 32px", textAlign: "center" }}>
        <div style={{ marginBottom: "24px" }}>
          <svg style={{ width: "48px", height: "48px", color: "var(--p-color-icon-success)" }} viewBox="0 0 20 20" fill="currentColor">
  ...
  return (
    <Card>
      <div style={{ padding: "32px" }}>
        ...
        <p style={{ marginTop: "20px", marginBottom: "20px", color: "var(--p-color-text-subdued)" }}>
          Create zones to define service areas, set delivery fees, and manage coverage.
        </p>
        ...
        >
          ...
          <Form onSubmit={(e: any) => e.preventDefault()}>
            <FormLayout>
              ...
              />
              <div>
                <label style={{ display: "block", marginBottom: "8px", fontWeight: "500" }}>Coverage Radius (km)</label>
                <input
                  type="text"
                  placeholder="5"
                  value={newZoneRadius}
                  onChange={(e) => onNewZoneRadiusChange(e.target.value)}
                  style={{ width: "100%", padding: "8px", border: "1px solid var(--p-color-border)", borderRadius: "4px" }}
                />
              </div>
              <div>
                <label style={{ display: "block", marginBottom: "8px", fontWeight: "500" }}>Delivery Fee ($)</label>
                <input
                  type="text"
                  placeholder="0"
  ...
  return (
    <Card>
      <div style={{ padding: "32px" }}>
        ...
        <p style={{ marginTop: "20px", marginBottom: "24px", color: "var(--p-color-text-subdued)" }}>
        ...
        <Form onSubmit={(e: any) => e.preventDefault()}>
          <FormLayout>
            <div>
              <label style={{ display: "block", marginBottom: "8px", fontWeight: "500" }}>Daily Order Cutoff Time</label>
              <input
                type="text"
                placeholder="14:00"
                value={deliveryRules.cutoffTime}
                onChange={(e) =>
                  onDeliveryRulesChange({ ...deliveryRules, cutoffTime: e.target.value })
                }
                style={{ width: "100%", padding: "8px", border: "1px solid var(--p-color-border)", borderRadius: "4px" }}
              />
            </div>
            ...
            <div style={{ marginTop: "12px", marginBottom: "12px" }}>
              <label style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                ...
                />
                <span>Enable Same-Day Delivery (available only for orders before cutoff time)</span>
              </label>
            </div>
        ...
        <div style={{ marginTop: "24px" }}>
          <Banner tone="info" title="Delivery Rules Info">
            <Text as="p">
              You can adjust these settings later from Settings &gt; Delivery Rules.
            </Text>
          </Banner>
        </div>
      </div>
          ...
          <FormLayout>
            <div>
              ...
              {carriers.map((carrier) => (
                <label key={carrier.value} style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
                  <input
                    type="radio"
    ...
    <Card>
      <div style={{ padding: "32px" }}>
        ...
        <div style={{ marginBottom: "20px" }}>
          ...
          <p style={{ marginTop: "8px", fontSize: "12px", color: "var(--p-color-text-subdued)", margin: "8px 0 0 0" }}>
