  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <path
            d="M24 4C12.96 4 4 12.96 4 24s8.96 20 20 20 20-8.96 20-20S35.04 4 24 4zm-2 30v-4h4v4h-4zm0-8V14h4v12h-4z"
            fill="var(--p-color-icon-subdued, #8c9196)"
          />
        </svg>
      </div>
      ...
      {(actionLabel && (actionUrl || onAction)) && (
        actionUrl ? (
          <a href={actionUrl} style={actionButtonStyle}>
            {actionLabel}
          </a>
        ) : (
          <button onClick={onAction} style={actionButtonStyle} type="button">
            {actionLabel}
          </button>
        )
      )}
