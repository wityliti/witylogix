...
function buildMetrics(stats: LocalKPIStats): KPIMetric[] {
...
export function LiveKPICounters({ className }: LiveKPICountersProps) {
  ...
  const metrics: KPIMetric[] = stats ? buildMetrics(stats as unknown as LocalKPIStats) : [];
