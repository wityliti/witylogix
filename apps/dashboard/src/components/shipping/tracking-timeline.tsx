          ...
          return (
            <div key={event.id} className="flex gap-4 relative">
              ...
              <div className="flex flex-col items-center">
                ...
                >
                  {statusIconMap[event.status] && (
                    <span className="text-[10px]">{statusIconMap[event.status]}</span>
                  )}
                </div>
                ...
                {!isLast && (
                  <div
                    className={cn(
                      'w-0.5 h-12 my-1',
                      isCurrent || visibleEvents[index + 1]?.status === currentStatus
              ...
              <div className="flex-1 pt-0.5 pb-4">
                ...
                <p className="text-xs text-wl-text-tertiary mt-1">{event.location}</p>
              </div>
            </div>
          );
        })}
