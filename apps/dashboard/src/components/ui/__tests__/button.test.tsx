...
describe('Button Component', () => {
  ...
  describe('States', () => {
    ...
    it('should be disabled when disabled prop is true', () => {
      const { container } = render(<Button disabled={true}>Cannot Click</Button>);
      const button = container.querySelector('button') as HTMLButtonElement;
      expect(button.disabled).toBe(true);
    });
    ...
    it('should have focus styles', () => {
      ...
      expect(button?.className).toContain('focus-visible:outline-wl-primary-500');
    });
  ...
  describe('className Merging with cn()', () => {
    ...
    it('should handle multiple custom classes', () => {
      const { container } = render(
        <Button className="class-1 class-2 class-3">
          Multiple Classes
        </Button>
      );
  ...
  describe('Forward Ref', () => {
    it('should forward ref to button element', () => {
      ...
      const { container } = render(
        <Button ref={ref as any}>Ref</Button>
      );
