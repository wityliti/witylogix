...
describe("DatePicker Component", () => {
  ...
  describe("Calendar Open/Close", () => {
    ...
    it("should close calendar on escape key", async () => {
      ...
      const calendar = Array.from(
        container.querySelectorAll('[class*="absolute"]'),
      ).find((el) => el.className.includes("grid-cols-7"));
    ...
    it("should close calendar on outside click", async () => {
      ...
      const calendarGrid = Array.from(
        container.querySelectorAll('[class*="grid"]'),
      ).find((el) => el.className.includes("grid-cols-7"));
  ...
  describe("Date Selection", () => {
    it("should call onChange when date is selected", async () => {
      ...
      const dateButtons = container.querySelectorAll(
        '[class*="rounded-md"][class*="flex"]',
      );
  ...
  describe("Month Navigation", () => {
    it("should navigate to next month", async () => {
      ...
      const monthDisplay = container.querySelector(
        '[class*="font-semibold"][class*="text-wl-text-primary"]',
      );
    ...
    it("should display correct month and year", async () => {
      ...
      expect(monthDisplay?.textContent).toMatch(
  ...
  describe("Min/Max Date Constraints", () => {
    ...
    it("should show disabled state styling", async () => {
      ...
      const disabledButton = container.querySelector(
        'button[disabled][class*="text-wl-text-tertiary"]',
      );
  ...
  describe("Today Highlighting", () => {
    it("should highlight today in calendar", async () => {
      ...
      const todayButton = Array.from(container.querySelectorAll("button")).find(
        (btn) =>
          btn.textContent?.trim() === String(today.getDate()) &&
