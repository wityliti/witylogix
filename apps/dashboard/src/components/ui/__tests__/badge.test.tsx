...
describe('Badge Component', () => {
  ...
  describe('Variants', () => {
    ...
    it('should handle all variant types', () => {
      const variants = ['default', 'success', 'warning', 'danger', 'info', 'primary'] as const;
  ...
  describe('Dot Indicator', () => {
    ...
    it('should work with all variants', () => {
      ...
      variants.forEach((variant) => {
        const { container } = render(<Badge variant={variant} dot>{variant}</Badge>);
        const badge = container.querySelector('span');
  ...
  describe('className Merging with cn()', () => {
    ...
    it('should work with multiple custom classes', () => {
      const { container } = render(
        <Badge className="class-1 class-2 class-3">
          Multiple
        </Badge>
      );
      const badge = container.querySelector('span');
  ...
  describe('Forward Ref', () => {
    ...
    it('should allow ref assignment', () => {
      ...
      const { container } = render(
        <Badge ref={ref as any}>Ref Test</Badge>
      );
      const badge = container.querySelector('span');
      expect(badge).toBeTruthy();
    });
  ...
  describe('HTML Attributes', () => {
    ...
    it('should support title attribute', () => {
      const { container } = render(
        <Badge title="Badge title">Badge</Badge>
      );
      const badge = container.querySelector('span');
