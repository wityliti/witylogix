              ...
              <div key={step} className="flex-1 flex items-center">
                ...
                <div
                  className={cn(
                    ...
                    status === "active" &&
                      "bg-wl-primary-100 dark:bg-wl-primary-900/30 ring-2 ring-wl-primary-500/20",
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <div
                ...
                style={{ color: getTokenStatusColor() }}
              >
                {getTokenStatusLabel()}
              </div>
              {expiresAt && (
                <div className="text-xs text-wl-text-secondary mt-1">
                  Expires in {timeUntilExpiry} days (
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-2 gap-2">
          {[
            ...
            <div
              key={scope}
              className="flex items-center gap-2 text-sm text-wl-text-secondary"
            >
