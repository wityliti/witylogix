...
export function ProviderSwitcher({
  ...
  const disconnectedCount = providers.filter(
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <div
                      ...
                      style={{
                        backgroundColor: getStatusColor(activeProvider.status),
                      }}
                    />
                    <span className="text-xs text-wl-text-secondary">
                      {getStatusLabel(activeProvider.status)}
                    </span>
                  </div>
                </div>
              </>
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="max-h-96 overflow-y-auto">
            {(
              ["ecommerce", "payment", "communication", "automation"] as const
            ).map((category) => {
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {activeProviderId === provider.id && (
                            <span className="text-wl-primary-500 text-lg">
                              ✓
                            </span>
                          )}
                        </div>
            ...
            {/* Empty State */}
            {Object.values(groupedProviders).every(
              (arr) => arr.length === 0,
            ) && (
