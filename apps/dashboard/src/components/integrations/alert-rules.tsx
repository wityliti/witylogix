            ...
            rules.map((rule) => (
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  <div className="text-sm font-medium text-wl-text-primary flex-1 truncate">
                    {rule.name}
                  </div>
                  <button
                    onClick={(e) => {
                ...
                <div className="flex items-center gap-2">
                  <span
                    className={cn(
                      ...
                      getPriorityBadgeClass(rule.priority),
                    )}
                  >
                    {rule.priority}
                  </span>
          ...
          <div className="flex-1 overflow-y-auto p-4">
                ...
                <div className="grid grid-cols-2 gap-3 mb-3">
                  <div>
                    ...
                    <input
                      type="text"
                      value={
                        editingRule?.condition.metric ||
                        current.condition.metric
                      }
                      onChange={(e) => {
                  ...
                  <div>
                    ...
                    <select
                      value={
                        editingRule?.condition.operator ||
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      type="number"
                      value={
                        editingRule?.condition.value || current.condition.value
                      }
                      onChange={(e) => {
                        if (!editingRule) setEditingRule({ ...current });
                        setEditingRule((prev) =>
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      value={
                        editingRule?.condition.duration ||
                  ...
                  (priority) => (
                    <button
                      ...
                      className={cn(
                        ...
                        (editingRule?.priority || current.priority) ===
                          priority && "ring-2 ring-wl-primary-500/20",
                      )}
                      style={{
                        backgroundColor:
                          (editingRule?.priority || current.priority) ===
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 gap-2">
                {(["email", "slack", "webhook", "in-app"] as const).map(
                  (action) => (
                    <button
                      key={action}
                      onClick={() => {
                      ...
                      className={cn(
                        "px-3 py-2 rounded-lg text-sm font-medium transition-colors",
                        (editingRule?.actions || current.actions).includes(
                          action,
                        )
            ...
            <div>
              ...
              <div className="space-y-2 max-h-40 overflow-y-auto">
                {current.recentAlerts.length === 0 ? (
                  <div className="text-xs text-wl-text-tertiary p-3 text-center">
                    No recent alerts
                  </div>
                ) : (
