              ...
              <div key={step} className="flex-1 flex items-center">
                <div
                  className={cn(
                    ...
                    isActive &&
                      "bg-wl-primary-100 dark:bg-wl-primary-900/30 text-wl-primary-700 dark:text-wl-primary-300 ring-2 ring-wl-primary-500/20",
                    !isCompleted &&
                      !isActive &&
                      "bg-wl-border-subtle text-wl-text-secondary",
                  )}
                >
                  {isCompleted ? "✓" : index + 1}
                </div>
            ...
            {mode === "import" ? (
              ...
              <div>
                ...
                <div className="p-4 rounded-lg bg-wl-surface-hover border border-wl-border-subtle">
                  <div className="text-sm font-medium text-wl-text-primary mb-2">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-wl-border-subtle">
                    <th className="text-left p-3 font-semibold text-wl-text-primary">
                      First Name
                    </th>
                    <th className="text-left p-3 font-semibold text-wl-text-primary">
                      Last Name
                ...
                <tbody>
                  {[1, 2, 3].map((idx) => (
                    <tr
                      key={idx}
                      className="border-b border-wl-border-subtle hover:bg-wl-surface-hover"
                    >
            ...
            <div className="space-y-3 mb-6">
              <div className="p-4 rounded-lg bg-wl-success-500/10 border border-wl-success-500/20">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <div className="font-semibold text-wl-success-700 dark:text-wl-success-300">
                    1,200 records valid
                  </div>
                </div>
                <div className="text-xs text-wl-text-secondary">
              ...
              <div className="p-4 rounded-lg bg-wl-warning-500/10 border border-wl-warning-500/20">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <div className="font-semibold text-wl-warning-700 dark:text-wl-warning-300">
                    50 warnings
                  </div>
                </div>
                <div className="text-xs text-wl-text-secondary">
                  Some records have incomplete data (email addresses will be
                  required)
                </div>
              </div>
            </div>
        ...
        {data.step === "complete" && (
          <div className="text-center">
            ...
            <div className="p-4 rounded-lg bg-wl-success-500/10 border border-wl-success-500/20 mb-6">
              <div className="text-xs text-wl-text-secondary">
                {mode === "import"
                  ? "Next steps: Review the imported data"
                  : "Download your file from the notification"}
              </div>
            </div>
          </div>
        )}
