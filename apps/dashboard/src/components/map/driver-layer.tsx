...
function buildFeatures(drivers: DriverMarker[], selectedDriverId?: string | null): Feature<Point>[] {
...
export function DriverLayer({ drivers, selectedDriverId, onDriverClick }: DriverLayerProps) {
  const map = useWLMap();
    ...
    const setup = () => {
      ...
      map.addLayer({
        ...
        layout: {
          ...
          'text-size': 10,
          'text-font': ['DM Sans Bold', 'Open Sans Bold', 'Arial Unicode MS Regular'],
