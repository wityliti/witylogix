...
const PasswordStrengthMeter = forwardRef<
  HTMLDivElement,
        ...
        <div ref={ref} className={cn("w-full space-y-4", className)} {...props}>
                ...
                {REQUIREMENTS.map((req) => {
                  ...
                  return (
                    ...
                    >
                      {isMet ? (
                        <Check
                          className="w-4 h-4 text-wl-success-400 flex-shrink-0"
                          strokeWidth={3}
                        />
                      ) : (
          ...
          {currentPassword && metRequirements.length < REQUIREMENTS.length && (
            <p className="text-xs text-wl-text-tertiary">
              ...
              {REQUIREMENTS.length - metRequirements.length === 1 ? "" : "s"} to
              go
            </p>
          )}
        </div>
