...
const INTEGRATIONS: Integration[] = [
  ...
  { id: "microsoft-dynamics", name: "Microsoft Dynamics", category: "ERP", color: "#00A4EF" },
  ...
  { id: "ms-dynamics-crm", name: "Dynamics 365", category: "CRM", color: "#00A4EF" },

  // Accounting
  { id: "quickbooks", name: "QuickBooks", category: "Accounting", color: "#31A54C" },
  { id: "xero", name: "Xero", category: "Accounting", color: "#003B61" },
  { id: "freshbooks", name: "FreshBooks", category: "Accounting", color: "#1CBDA8" },
  { id: "wave", name: "Wave", category: "Accounting", color: "#FFA500" },

  // Warehouse
  { id: "oracle-netsuite", name: "Oracle WMS", category: "Warehouse", color: "#F80000" },
  { id: "manhattan", name: "Manhattan", category: "Warehouse", color: "#003D7A" },
...
const IntegrationChipGrid = forwardRef<HTMLDivElement, IntegrationChipGridProps>(
  ({ selected = [], onSelectionChange, maxInitialShow = 4, className, ...props }, ref) => {
    ...
    const grouped = useMemo(() => {
      ...
      if (searchQuery) {
        ...
        Object.keys(groups).forEach((cat) => {
          groups[cat] = groups[cat].filter((int) =>
      ...
      >
        ...
        <div className="space-y-4">
          {grouped.map(({ category, integrations }) => {
            ...
            const displayCount = isExpanded ? integrations.length : maxInitialShow;
