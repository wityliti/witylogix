      ...
      <div className="relative w-32 h-32">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-xl font-bold text-[var(--wl-text-primary)]">
              {total}
            </p>
          </div>
        </div>
        ...
        {segments.map((s) => (
          <div key={s.channel} className="flex items-center gap-2">
            <div
              ...
              style={{
                backgroundColor:
                  CHANNEL_COLORS[s.channel] ?? "var(--wl-neutral-500)",
              }}
            />
...
export function NotificationStatsWidget({
  ...
  const { data, loading, error, refetch } = useApiQuery<StatsPayload>(
