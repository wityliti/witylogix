...
function makeLoader<T>(loader: () => Promise<{ default: T }>): () => Promise<{ default: AnyComponent }> {
...
export const LazyCartesianGrid = dynamic(
  makeLoader(() => import('./index').then((m) => ({ default: m.CartesianGrid }))),
  { ssr: false }
);
...
export const LazyResponsiveContainer = dynamic(
  makeLoader(() => import('./index').then((m) => ({ default: m.ResponsiveContainer }))),
  { ssr: false }
);
