...
type SortField = "courier" | "baseRate" | "perKm" | "perKg" | "minCharge" | "estTime" | "coverage" | "rating";
...
const RateComparisonTable = forwardRef<HTMLDivElement, RateComparisonTableProps>(
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="flex items-center justify-center py-8">
              <p className="text-sm text-wl-text-secondary">No comparison data available</p>
            </div>
          ) : (
