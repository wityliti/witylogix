    ...
    return (
      ...
      >
            ...
            <div className="min-w-0 flex-1">
              <h3
                className={cn(
                  ...
                  state !== "error" &&
                    state !== "success" &&
                    "text-wl-text-primary dark:text-wl-neutral-300",
                )}
              >
          ...
          {state === "syncing" && onCancel && (
            <button
              ...
              className={cn(
                ...
                "w-6 h-6 p-1",
                "text-wl-text-tertiary dark:text-wl-text-secondary hover:text-wl-text-primary dark:hover:text-wl-text-primary",
                "rounded transition-colors",
                "hover:bg-wl-neutral-200 dark:hover:bg-wl-bg-elevated",
              )}
        ...
        <div className="w-full">
          <div
            className={cn(
              "w-full h-2 bg-wl-neutral-200 dark:bg-wl-bg-overlay rounded-full overflow-hidden",
            )}
          >
            <div
              className={cn(
        ...
        <div className="flex items-center justify-between gap-3 flex-wrap">
          ...
          <div className="text-xs text-wl-text-tertiary dark:text-wl-text-secondary">
            <span className="font-semibold text-wl-text-primary dark:text-wl-text-primary">
              {itemsSynced}
            </span>
            {" / "}
