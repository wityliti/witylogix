    ...
    <>
      ...
      <div className="p-6 bg-wl-bg-root space-y-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { label: 'Active Providers', value: stats.total, icon: Mail, color: 'text-blue-400' },
          ...
          <CardContent>
            {stats.templates === 0 ? (
              ...
              <p className="text-sm text-wl-text-secondary">
                ...
                <Link href="/settings/notifications/templates" className="text-blue-400 hover:underline">
                  View all →
                </Link>
              </p>
            )}
