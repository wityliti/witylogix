          ...
          <CardContent>
            <div className="p-12 text-center">
              ...
              <p className="text-wl-text-secondary mb-1">
                Telematics integrations coming soon
              </p>
              <p className="text-sm text-wl-text-muted mb-6 max-w-sm mx-auto">
                Vehicle telemetry connections for Samsara, Geotab, Flespi,
                Verizon Connect, Trimble, and more are not yet available in the
                marketplace. Contact support to request early access.
              </p>
