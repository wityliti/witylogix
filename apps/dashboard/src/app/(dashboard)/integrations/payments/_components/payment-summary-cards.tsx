...
export function PaymentSummaryCards({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      <Card className="bg-gradient-to-br from-blue-500/10 to-blue-500/5 border-wl-info-500/30">
        <CardContent className="pt-6">
          <p className="text-xs font-medium text-wl-info-500 uppercase">
            Total Volume
          </p>
          <p className="text-3xl font-bold text-wl-info-500 mt-2">
            ${totalVolume.toLocaleString('en-US', { maximumFractionDigits: 2 })}
          </p>
          <p className="text-xs text-wl-info-500 mt-2">
      ...
      <Card className="bg-gradient-to-br from-blue-500/10 to-blue-500/5 border-wl-info-500/30">
        <CardContent className="pt-6">
          ...
          <p className="text-3xl font-bold text-wl-info-400 mt-2">
