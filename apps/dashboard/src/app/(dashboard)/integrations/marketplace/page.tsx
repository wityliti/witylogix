...
const ALL_PROVIDERS: Provider[] = [
  ...
  { id: "crm-6", slug: "sugarcrm", name: "SugarCRM", category: "CRM", description: "Customer-centric CRM", status: "COMING_SOON", authType: "api_key", popular: false, addedDate: "2025-07-01", connected: false },
  { id: "crm-7", slug: "vtiger", name: "Vtiger", category: "CRM", description: "Open-source CRM", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-04-25", connected: false },
  ...
  { id: "email-7", slug: "postmark", name: "Postmark", category: "EMAIL", description: "Fast & reliable email", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-06-08", connected: false },
  { id: "email-8", slug: "brevo", name: "Brevo", category: "EMAIL", description: "Omnichannel marketing platform", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-05-30", connected: false },
  { id: "email-9", slug: "klaviyo", name: "Klaviyo", category: "EMAIL", description: "Email marketing for e-commerce", status: "AVAILABLE", authType: "oauth2", popular: false, addedDate: "2025-06-03", connected: false },
  { id: "email-10", slug: "mailchimp", name: "Mailchimp", category: "EMAIL", description: "Email marketing made easy", status: "AVAILABLE", authType: "oauth2", popular: true, addedDate: "2025-06-01", connected: false },
  { id: "email-11", slug: "constant-contact", name: "Constant Contact", category: "EMAIL", description: "Email marketing & automation", status: "AVAILABLE", authType: "oauth2", popular: false, addedDate: "2025-05-25", connected: false },
  ...
  { id: "routing-6", slug: "tomtom", name: "TomTom", category: "ROUTING", description: "Mapping & location APIs", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-06-03", connected: false },
  ...
  { id: "telematics-5", slug: "omnitracs", name: "Omnitracs", category: "TELEMATICS", description: "Fleet visibility platform", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-06-08", connected: false },
  ...
  { id: "inventory-5", slug: "dear", name: "DEAR Inventory", category: "INVENTORY", description: "Inventory & order mgmt", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-06-10", connected: false },
  { id: "inventory-6", slug: "infoplus", name: "infoplus", category: "INVENTORY", description: "Warehouse management", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-06-08", connected: false },
  ...
  { id: "payment-5", slug: "adyen", name: "Adyen", category: "PAYMENTS", description: "Global payments", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-06-10", connected: false },
  { id: "payment-6", slug: "authorize-net", name: "Authorize.Net", category: "PAYMENTS", description: "Payment gateway", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-06-08", connected: false },
  { id: "payment-7", slug: " 2checkout", name: "2Checkout", category: "PAYMENTS", description: "Global payment solutions", status: "COMING_SOON", authType: "api_key", popular: false, addedDate: "2025-07-01", connected: false },
  ...
  { id: "analytics-5", slug: "looker", name: "Looker", category: "ANALYTICS", description: "Business intelligence", status: "AVAILABLE", authType: "oauth2", popular: false, addedDate: "2025-06-10", connected: false },
  ...
  { id: "ecom-5", slug: "opencart", name: "OpenCart", category: "ECOMMERCE", description: "Shopping cart software", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-06-10", connected: false },
  { id: "ecom-6", slug: "commerce-tools", name: "commercetools", category: "ECOMMERCE", description: "Headless commerce", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-06-08", connected: false },
  { id: "ecom-7", slug: "saleor", name: "Saleor", category: "ECOMMERCE", description: "Open-source commerce", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-06-05", connected: false },
  { id: "ecom-8", slug: "medusa", name: "Medusa", category: "ECOMMERCE", description: "Composable commerce", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-06-03", connected: false },
  { id: "ecom-9", slug: "shopware", name: "Shopware", category: "ECOMMERCE", description: "E-commerce platform", status: "AVAILABLE", authType: "oauth2", popular: false, addedDate: "2025-06-01", connected: false },
  { id: "ecom-10", slug: "acquia", name: "Acquia Commerce", category: "ECOMMERCE", description: "Drupal commerce", status: "COMING_SOON", authType: "api_key", popular: false, addedDate: "2025-07-01", connected: false },
  { id: "ecom-11", slug: "fabric", name: "Fabric", category: "ECOMMERCE", description: "Composable platform", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-06-04", connected: false },

  // ERP (5)
  { id: "erp-1", slug: "sap", name: "SAP", category: "ERP", description: "Enterprise resource planning", status: "AVAILABLE", authType: "api_key", popular: true, addedDate: "2025-06-20", connected: false },
  { id: "erp-2", slug: "oracle", name: "Oracle", category: "ERP", description: "Enterprise software", status: "AVAILABLE", authType: "api_key", popular: true, addedDate: "2025-06-18", connected: false },
  { id: "erp-3", slug: "netsuite", name: "NetSuite", category: "ERP", description: "Cloud ERP platform", status: "AVAILABLE", authType: "oauth2", popular: false, addedDate: "2025-06-15", connected: false },
  { id: "erp-4", slug: "dolibarr", name: "Dolibarr", category: "ERP", description: "Open-source ERP", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-06-12", connected: false },
  ...
  { id: "fuel-2", slug: "smartfuel", name: "SmartFuel", category: "FUEL", description: "Fuel card integration", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-06-18", connected: false },
  { id: "fuel-3", slug: "wex", name: "WEX", category: "FUEL", description: "Fleet fuel cards", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-06-15", connected: false },
  { id: "fuel-4", slug: "voyager", name: "Voyager", category: "FUEL", description: "Fuel payment network", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-06-12", connected: false },

  // POS (5)
  { id: "pos-1", slug: "toast", name: "Toast", category: "POS", description: "Restaurant POS system", status: "AVAILABLE", authType: "oauth2", popular: true, addedDate: "2025-06-20", connected: false },
  { id: "pos-2", slug: "lightspeed", name: "Lightspeed", category: "POS", description: "Retail POS software", status: "AVAILABLE", authType: "oauth2", popular: true, addedDate: "2025-06-18", connected: false },
  { id: "pos-3", slug: "clover", name: "Clover", category: "POS", description: "Point of sale platform", status: "AVAILABLE", authType: "oauth2", popular: true, addedDate: "2025-06-15", connected: false },
  { id: "pos-4", slug: "shopify-pos", name: "Shopify POS", category: "POS", description: "Unified POS system", status: "AVAILABLE", authType: "oauth2", popular: false, addedDate: "2025-06-12", connected: false },
  { id: "pos-5", slug: "vend", name: "Vend", category: "POS", description: "Cloud POS platform", status: "COMING_SOON", authType: "oauth2", popular: false, addedDate: "2025-07-01", connected: false },

  // LASTMILE (3)
  { id: "lastmile-1", slug: "roadie", name: "Roadie", category: "LASTMILE", description: "On-demand delivery", status: "AVAILABLE", authType: "api_key", popular: true, addedDate: "2025-06-20", connected: false },
  { id: "lastmile-2", slug: "onfleet", name: "OnFleet", category: "LASTMILE", description: "Last-mile delivery", status: "AVAILABLE", authType: "api_key", popular: true, addedDate: "2025-06-18", connected: false },
  { id: "lastmile-3", slug: "relay", name: "Relay", category: "LASTMILE", description: "Delivery automation", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-06-15", connected: false },

  // FREIGHT (4)
  { id: "freight-1", slug: "freightos", name: "Freightos", category: "FREIGHT", description: "Freight marketplace", status: "AVAILABLE", authType: "api_key", popular: true, addedDate: "2025-06-20", connected: false },
  { id: "freight-2", slug: "convoy", name: "Convoy", category: "FREIGHT", description: "Freight platform", status: "AVAILABLE", authType: "api_key", popular: true, addedDate: "2025-06-18", connected: false },
  { id: "freight-3", slug: "loadsmart", name: "Loadsmart", category: "FREIGHT", description: "Freight brokerage", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-06-15", connected: false },
  { id: "freight-4", slug: "ffxp", name: "Forward Air", category: "FREIGHT", description: "Freight services", status: "COMING_SOON", authType: "api_key", popular: false, addedDate: "2025-07-01", connected: false },

  // SUPPLY_CHAIN (6)
  { id: "sc-1", slug: "blume-global", name: "Blume Global", category: "SUPPLY_CHAIN", description: "Supply chain visibility", status: "AVAILABLE", authType: "api_key", popular: true, addedDate: "2025-06-20", connected: false },
  { id: "sc-2", slug: "fourkites", name: "FourKites", category: "SUPPLY_CHAIN", description: "Shipment visibility", status: "AVAILABLE", authType: "api_key", popular: true, addedDate: "2025-06-18", connected: false },
  { id: "sc-3", slug: "jagg", name: "Jagg", category: "SUPPLY_CHAIN", description: "Supply chain planning", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-06-15", connected: false },
  { id: "sc-4", slug: "kinaxis", name: "Kinaxis", category: "SUPPLY_CHAIN", description: "Supply chain planning", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-06-12", connected: false },
  { id: "sc-5", slug: "logility", name: "Logility", category: "SUPPLY_CHAIN", description: "Demand planning", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-06-10", connected: false },
  { id: "sc-6", slug: "trackwise", name: "TrackWise", category: "SUPPLY_CHAIN", description: "Quality management", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-06-08", connected: false },

  // CATALOG (5)
  { id: "catalog-1", slug: "contentstack", name: "Contentstack", category: "CATALOG", description: "Headless CMS", status: "AVAILABLE", authType: "api_key", popular: true, addedDate: "2025-06-20", connected: false },
  { id: "catalog-2", slug: "contentful", name: "Contentful", category: "CATALOG", description: "Content infrastructure", status: "AVAILABLE", authType: "api_key", popular: true, addedDate: "2025-06-18", connected: false },
  { id: "catalog-3", slug: "sanity", name: "Sanity", category: "CATALOG", description: "Structured content", status: "AVAILABLE", authType: "oauth2", popular: true, addedDate: "2025-06-15", connected: false },
  { id: "catalog-4", slug: "strapi", name: "Strapi", category: "CATALOG", description: "Open-source CMS", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-06-12", connected: false },
  { id: "catalog-5", slug: "hygraph", name: "Hygraph", category: "CATALOG", description: "Federated content", status: "AVAILABLE", authType: "api_key", popular: false, addedDate: "2025-06-10", connected: false },

  // ESIGNATURES (3)
  { id: "sig-1", slug: "docusign", name: "DocuSign", category: "ESIGNATURES", description: "E-signature platform", status: "AVAILABLE", authType: "oauth2", popular: true, addedDate: "2025-06-20", connected: false },
  { id: "sig-2", slug: "adobe-sign", name: "Adobe Sign", category: "ESIGNATURES", description: "Digital signatures", status: "AVAILABLE", authType: "oauth2", popular: true, addedDate: "2025-06-18", connected: false },
  { id: "sig-3", slug: "hellosign", name: "HelloSign", category: "ESIGNATURES", description: "E-signature service", status: "AVAILABLE", authType: "oauth2", popular: false, addedDate: "2025-06-15", connected: false },
];
        ...
        <div className={cn("flex flex-col gap-4 mb-6")}>
          ...
          <div className={cn("flex flex-wrap gap-3 items-center")}>
            ...
            <div className={cn("relative")}>
              ...
              >
                {(["name", "category", "popularity", "recently_added"] as const).map(
                  (opt) => (
                    <button
                      key={opt}
