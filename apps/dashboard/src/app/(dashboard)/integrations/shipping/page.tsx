            ...
            {SHIPPING_CARRIERS.map((carrier) => (
              <Card
                ...
                className={cn(
                  ...
                  selectedCarrier === carrier.id && "ring-2 ring-wl-primary-500"
                )}
              >
                ...
                {carrier.status === "connected" && (
                  <div className="space-y-2 text-xs text-wl-text-secondary mb-4">
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="grid grid-cols-4 gap-3 text-xs text-wl-text-secondary mb-4 pb-4 border-b border-wl-border-subtle">
                <div>
                  <label className="block text-wl-text-tertiary text-xs font-semibold mb-1">
                    FROM
                  </label>
                  <input
                    type="text"
                    value="New York, NY"
                    disabled
                    className="w-full p-2 bg-wl-bg-surface border border-wl-border-subtle rounded text-sm text-wl-text-secondary"
                  />
                </div>
                <div>
                  <label className="block text-wl-text-tertiary text-xs font-semibold mb-1">
              ...
              <div className="flex gap-2 pt-3 border-t border-wl-border-subtle">
              ...
              {filteredShipments.map((shipment) => (
                ...
                >
                  <div
                    ...
                    className="p-4 cursor-pointer hover:bg-wl-bg-overlay/30"
                  >
                    ...
                    <div className="grid grid-cols-4 gap-2 text-xs">
                      <div>
                        <span className="text-wl-text-tertiary">Carrier:</span>
                        <p className="font-semibold text-wl-text-primary">{shipment.carrier}</p>
                      </div>
                      <div>
                      ...
                      <div>
                        <span className="text-wl-text-tertiary">Cost:</span>
                        <p className="font-semibold text-wl-text-primary">
                          {formatCurrency(shipment.cost)}
                        </p>
                      </div>
                      <div className="text-right">
                        <span className="text-wl-text-tertiary">Est. Delivery:</span>
                        <p className="font-semibold text-wl-text-primary">
                  ...
                  {expandedShipment === shipment.id && (
                    <div className="bg-wl-bg-overlay/50 border-t border-wl-border-subtle p-4">
                      <h5 className="text-xs font-semibold text-wl-text-primary mb-3 uppercase tracking-wider">
                        Delivery Timeline
                      </h5>
                      <div className="space-y-2">
                        {shipment.timeline.map((event, idx) => (
                          <div
                            key={idx}
                            className="flex items-start gap-3 pb-2 last:pb-0 border-b border-wl-border-subtle last:border-0"
                          >
                            <div className="flex-shrink-0">
                              <div className="w-2 h-2 rounded-full bg-wl-primary-500 mt-1.5" />
                            </div>
                            <div className="flex-1">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-wl-border-subtle">
                    <th className="p-3 text-left font-semibold text-wl-text-secondary">Date</th>
                ...
                <tbody>
                  {ANALYTICS.map((analytic, idx) => (
                    ...
                    >
                      ...
                      <td className="p-3 text-center text-wl-text-secondary">
