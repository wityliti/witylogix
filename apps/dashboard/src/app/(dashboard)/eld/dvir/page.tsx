                    ...
                    >
                      <div className="flex items-start justify-between gap-3 mb-2">
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-wl-text-secondary">{defect.description}</p>
            ...
            <CardHeader>
              <div className="flex items-center justify-between gap-4">
                <div>
                  ...
                  <p className="text-xs text-wl-text-secondary mt-1">Past vehicle inspections derived from delivery records</p>
                </div>
              </div>
                ...
                {showVehicleSearch && (
                  <div className="absolute top-full left-0 right-0 mt-1 z-10 bg-wl-bg-elevated border border-wl-border-default rounded-lg shadow-lg max-h-48 overflow-y-auto">
                    ...
                    {uniqueVehicles.length === 0 && (
                      <div className="px-3 py-2 text-xs text-wl-text-tertiary">No vehicles found</div>
                    )}
                  </div>
                )}
              </div>
