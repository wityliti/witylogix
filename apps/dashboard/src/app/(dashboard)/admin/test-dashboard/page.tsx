            ...
            <CardContent className="pt-6">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-wl-success-400">{stats.passed}</p>
            ...
            <CardContent className="pt-6">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-wl-danger-400">{stats.failed}</p>
            ...
            <CardContent className="pt-6">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-wl-warning-400">{stats.skipped}</p>
                </div>
                <TrendingUp className="w-8 h-8 text-wl-warning-400 opacity-60" />
              </div>
            </CardContent>
          </Card>
                  ...
                  <tbody>
                    {testResults.map((file, idx) => (
                      <tr key={idx} className="border-b border-wl-border-default hover:bg-wl-bg-elevated transition-colors">
                        ...
                        <td className="py-3 px-4 text-wl-success-400 font-medium">{file.passed}</td>
                        <td className="py-3 px-4">
                          <span className={cn("font-medium", file.failed > 0 ? "text-wl-danger-400" : "text-wl-success-400")}>
                            {file.failed}
                          </span>
                        </td>
