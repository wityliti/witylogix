...
const getRoleColor = (role: User["role"]): string => {
  switch (role) {
    case "admin":
      return "bg-wl-danger-bg text-wl-danger-400 border border-wl-danger-400/40";
    case "manager":
      return "bg-purple-500/10 text-purple-400 border border-purple-500/40";
    case "operator":
      return "bg-wl-info-bg text-wl-info-400 border border-wl-info-400/40";
    default:
      return "bg-wl-neutral-700/40 text-wl-neutral-400 border border-wl-neutral-400/40";
  }
};
