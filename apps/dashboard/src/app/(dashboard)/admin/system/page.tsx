  ...
  return (
    <Card>
      <CardContent className="pt-5 flex flex-col items-center">
        <Icon className={cn("w-6 h-6 mb-3", getColor(safeVal))} />
        ...
        <div className="relative w-24 h-24 mb-4">
          <svg width="100" height="100" viewBox="0 0 100 100" className="rotate-90">
            ...
            <circle
              ...
              className={cn("transition-all duration-300", getColor(safeVal))}
              strokeLinecap="round"
            />
          </svg>
          <div className="absolute inset-0 flex items-center justify-center">
            <span className={cn("text-2xl font-bold", getColor(safeVal))}>{safeVal}%</span>
          </div>
        </div>

        <p className="text-xs text-center text-gray-400">
          {safeVal < 50 ? "Normal" : safeVal < 75 ? "Elevated" : "High"}
        </p>
      </CardContent>
    </Card>
  );
    ...
    <div className="min-h-screen bg-[#12121a]">
      ...
      <div className="p-6 space-y-6">
        ...
        <div>
          ...
          {services.length === 0 ? (
            <Card className="border border-[#1e1e2e]">
              <CardContent className="pt-5 flex flex-col items-center py-12 text-gray-400">
        ...
        {metrics && (
          <>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <Card>
                <CardContent className="pt-5">
                  <p className="text-xs text-gray-400 uppercase tracking-wider mb-4">Server Uptime</p>
