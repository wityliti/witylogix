...
const SHADOW_TOKENS: Token[] = [
  ...
  {
    name: "Shadow Glow",
    cssVar: "--wl-shadow-glow",
    value: "0 0 20px rgba(245, 166, 35, 0.15)",
    category: "shadows",
  },
];
  ...
  const categories = [
    {
      ...
      name: "Colors",
      description:
        "Color palette with all primary, neutral, and semantic colors",
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="mb-6">
            ...
            <p className="text-wl-neutral-300">
              Complete reference of all design system tokens
            </p>
          </div>
                      ...
                      >
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex gap-2">
                            <button
                              onClick={() =>
                                handleCopy(token.cssVar, token.cssVar)
                              }
                              className={cn(
                            ...
                            <button
                              onClick={() =>
                                handleCopy(token.value, `${token.cssVar}-value`)
                              }
                              className={cn(
                                "flex-1 flex items-center justify-center gap-1 px-2 py-1 rounded text-xs",
                                "bg-wl-bg-surface border border-wl-border-default hover:border-wl-border-strong",
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            ...
                            <div className="text-xs text-wl-text-secondary space-y-1 font-mono">
                              ...
                              <div className="text-wl-neutral-300">
                                {token.value}
                              </div>
