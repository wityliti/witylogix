      ...
      <div className={cn("max-w-6xl mx-auto")}>
        ...
        >
          ...
          >
            ...
            >
              <div>
                <p className={cn("text-wl-text-secondary text-xs font-medium")}>
                  Total Quantity
                </p>
            ...
            <CardContent className={cn("p-0 overflow-hidden rounded-b-lg")}>
              {warehouseLoading ? (
                ...
                >
                  ...
                  <p className={cn("text-wl-text-tertiary text-xs")}>
              ...
              {!warehouseLoading &&
                ...
                warehousePins.length > 0 && (
                  <div
                    className={cn(
                      "flex items-center gap-4 px-4 py-3 border-t border-wl-border-default text-xs text-wl-text-secondary flex-wrap",
                    )}
                  >
                    <span className="font-medium text-wl-neutral-300">
                      Stock stress:
                    </span>
                    {[
                      { color: "var(--wl-info-500)", label: "Healthy (0%)" },
                      {
                        color: "var(--wl-chart-green)",
                        label: "Moderate (50%)",
                      },
                  ...
                  <table className={cn("w-full border-collapse")}>
                    <thead>
                      <tr className={cn("border-b-2 border-wl-border-default")}>
                        <th
                          className={cn(
                            "p-3 text-left text-wl-text-secondary text-xs font-semibold",
                          )}
                        >
                          SKU
                        </th>
                        ...
                        <th
                          className={cn(
                            "p-3 text-center text-wl-text-secondary text-xs font-semibold",
                          )}
                        >
                          Quantity
                        </th>
                      ...
                      {filteredItems.length === 0 ? (
                        <tr>
                          <td
                            colSpan={6}
                            className={cn(
                              "p-6 text-center text-wl-text-secondary text-sm",
                            )}
                          >
                        ...
                        filteredItems.map((item) => (
                          ...
                          >
                            ...
                            <td
                              className={cn(
                                "p-3 text-wl-text-secondary text-xs",
                              )}
                            >
                              {item.locationId}
                            </td>
                            ...
                            <td
                              className={cn(
                                "p-3 text-wl-text-secondary text-xs text-center",
                              )}
                            >
                              {item.reorderPoint}
                            </td>
            ...
            >
              ...
              <CardContent className={cn("flex flex-col gap-3")}>
                {lowStockAlerts.length === 0 ? (
                  <p
                    className={cn(
                      "text-wl-text-secondary text-xs text-center py-5",
                    )}
                  >
                    ...
                    {movements.length === 0 ? (
                      ...
                      movements.map((movement) => (
                        ...
                        >
                          ...
                          <td
                            className={cn("p-3 text-wl-text-secondary text-xs")}
                          >
                            {movement.reason}
                          </td>
                          <td
