    ...
    <WizardStep stepId={5} title="Review & Activate">
      <div className={cn("space-y-6 max-w-2xl")}>
        <Card>
          ...
          <CardContent className={cn("space-y-4")}>
            <div className={cn("grid grid-cols-2 gap-4")}>
              <div>
                <p className={cn("text-sm text-gray-400", "mb-1")}>Platform</p>
                <p className={cn("font-semibold text-white")}>{platformName}</p>
              </div>
              <div>
            ...
            <div>
              <p className={cn("text-sm text-gray-400", "mb-2")}>Objects</p>
        ...
        <div className={cn("flex justify-between gap-3 pt-6")}>
          ...
          <Button disabled={!isEnabled} onClick={onActivate}>
            Activate Connection
          </Button>
        </div>
      </div>
