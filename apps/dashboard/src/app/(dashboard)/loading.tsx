      ...
      <main className={cn('flex-1')}>
        ...
        <div className="mb-6 flex gap-2 animate-pulse">
          {Array.from({ length: 4 }).map((_, i) => (
            <div
              key={i}
              className="h-9 bg-wl-bg-elevated rounded px-4 w-24"
            />
          ))}
        </div>
        ...
        <div className="mb-6 flex gap-2 animate-pulse">
          {Array.from({ length: 3 }).map((_, i) => (
            <div
              key={i}
              className="h-10 bg-wl-bg-elevated rounded px-3 flex-1"
            />
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {Array.from({ length: 4 }).map((_, i) => (
            ...
            >
              <div className="h-4 bg-wl-bg-elevated rounded w-1/2 mb-3" />
              <div className="h-8 bg-wl-bg-elevated rounded w-2/3 mb-2" />
              <div className="h-3 bg-wl-bg-elevated rounded w-1/3" />
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            ...
            >
              <div className="h-4 bg-wl-bg-elevated rounded w-1/4 mb-6" />
              <div className="space-y-2">
                {[95, 72, 88, 65, 80].map((w, i) => (
                  <div
                    key={i}
                    className="h-2 bg-wl-bg-elevated rounded"
                    style={{ width: `${w}%` }}
                  />
                ))}
              </div>
            ...
            >
              <div className="h-5 bg-wl-bg-elevated rounded w-1/4 mb-4" />
          ...
          <div>
            ...
            >
              <div className="h-5 bg-wl-bg-elevated rounded w-1/3 mb-4" />
              <div className="space-y-3">
                {Array.from({ length: 4 }).map((_, i) => (
                  <div key={i} className="space-y-2">
                    <div className="h-3 bg-wl-bg-elevated rounded w-full" />
                    <div className="h-2 bg-wl-bg-elevated rounded w-2/3" />
                  </div>
                ))}
              </div>
            </div>
