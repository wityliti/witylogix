      ...
      <main className="flex-1 p-6 max-w-4xl mx-auto">
        ...
        <Card className="bg-wl-bg-surface border-wl-border-default mb-6">
          ...
          <CardContent className="space-y-4">
              ...
              <div>
                ...
                {isEditing ? (
                  <input
                    ...
                    className="w-full px-3 py-2 bg-wl-bg-overlay border border-wl-border-default rounded text-white text-sm focus:outline-none focus:border-wl-primary-500 focus:ring-1 focus:ring-wl-primary-500/30 transition-colors"
                  />
                ) : (
              ...
              <div>
                ...
                {isEditing ? (
                  <select
                    ...
                    className="w-full px-3 py-2 bg-wl-bg-overlay border border-wl-border-default rounded text-white text-sm focus:outline-none focus:border-wl-primary-500 transition-colors"
                  >
            ...
            {isEditing && (
              <div className="flex gap-3 pt-4 border-t border-wl-border-default">
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 bg-wl-primary-500 text-white rounded text-sm font-medium cursor-pointer hover:bg-wl-primary-600 disabled:opacity-60 transition-colors"
                >
            ...
            {saveSuccess && (
              <p className="text-sm text-wl-success-400">Profile saved successfully.</p>
            )}
            {saveError && (
        ...
        <Card className="bg-wl-bg-surface border-wl-border-default mb-6">
          ...
          <CardContent className="space-y-6">
            ...
            <div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-3 py-2 bg-wl-bg-overlay border border-wl-border-default rounded text-white text-sm pr-10 focus:outline-none focus:border-wl-primary-500 transition-colors"
                    />
                    <button
                      onClick={() => setShowPassword(!showPassword)}
                      className="absolute right-3 top-1/2 -translate-y-1/2 text-wl-text-tertiary hover:text-wl-text-secondary transition-colors"
                    >
              ...
              {pwError && <p className="text-sm text-wl-danger-400 mt-2">{pwError}</p>}
              {pwSuccess && <p className="text-sm text-wl-success-400 mt-2">Password updated successfully.</p>}

              <button
                onClick={handleChangePassword}
                disabled={pwLoading}
                className="mt-4 inline-flex items-center gap-2 px-4 py-2 bg-wl-primary-500 text-white rounded text-sm font-medium cursor-pointer hover:bg-wl-primary-600 disabled:opacity-60 transition-colors"
              >
            ...
            <div className="flex items-center justify-between p-4 bg-wl-bg-overlay rounded border border-wl-border-default">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-wl-text-secondary">Signed in as {userProfile.email || '—'}</p>
                </div>
              </div>
            </div>
          </CardContent>
