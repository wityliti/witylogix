    ...
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-1 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            {Array.from({ length: 4 }).map((_, i) => (
              <Card
                key={i}
                className="p-4 bg-wl-bg-elevated border-wl-border-subtle"
              >
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card
            className="bg-wl-bg-elevated border-wl-border-subtle overflow-hidden"
            style={{ height: 320 }}
          >
      ...
      <div className="min-h-screen flex flex-col items-center justify-center gap-6 p-6">
        ...
        <div className="text-center">
          <h2 className="text-lg font-semibold text-white mb-1">
            {customerError?.message?.includes("404")
              ? "Customer not found"
      ...
      <div className="p-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                  {customer.addresses.slice(0, 3).map((addr, i) => (
                    ...
                    >
                      ...
                      <span>
                        {[addr.address1, addr.city, addr.province, addr.country]
                          .filter(Boolean)
                          .join(", ")}
                      </span>
                    </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card
              className="overflow-hidden border border-white/[0.06] bg-wl-bg-surface"
              style={{ height: 340 }}
            >
                ...
                {ordersLoading ? (
                  <div className="p-6 space-y-3">
                    {Array.from({ length: 4 }).map((_, i) => (
                      <div
                        key={i}
                        className="h-12 animate-pulse rounded bg-white/[0.04]"
                      />
                    ))}
                  </div>
                ) : ordersError ? (
