            ...
            <div className="flex rounded-md border border-wl-border-default overflow-hidden">
              <button
                ...
                className={cn(
                  ...
                  view === 'grid' ? 'bg-blue-600 text-white' : 'text-wl-text-secondary hover:text-wl-text-primary',
                )}
              >
              ...
              <button
                ...
                className={cn(
                  'px-3 py-1.5 text-xs font-semibold flex items-center gap-1.5 transition-colors',
                  view === 'map' ? 'bg-blue-600 text-white' : 'text-wl-text-secondary hover:text-wl-text-primary',
                )}
              >
      ...
      <div className="p-6 space-y-5">
        ...
        <div className="flex gap-3 flex-wrap items-center">
          <input
            ...
            className="w-72 px-4 py-2 bg-wl-bg-surface border border-wl-border-default rounded-md text-wl-text-primary text-sm outline-none focus:border-blue-500/50 transition-colors"
          />
