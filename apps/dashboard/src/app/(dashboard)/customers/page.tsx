...
export default function CustomersPage() {
  ...
  const [tierFilter, setTierFilter] = useState<
    "all" | "standard" | "premium" | "enterprise"
  >("all");
  ...
  const totalPct =
    stats && stats.totalPrev > 0
      ? ((stats.total - stats.totalPrev) / stats.totalPrev) * 100
      : null;
  const activePct =
    stats && stats.total > 0 ? (stats.activeCount / stats.total) * 100 : null;
    ...
    <>
      ...
      <div className="p-6 space-y-5">
        ...
        <div className="flex gap-3 flex-wrap items-center">
          ...
          <div className="flex gap-1">
            {(["all", "standard", "premium", "enterprise"] as const).map(
              (t) => (
                <button
                  key={t}
                  onClick={() => {
                  ...
                  {loading ? (
                    ...
                    customers.map((c, idx) => (
                      ...
                      >
                        ...
                        <td className="p-3 px-4">
                          <div className="text-xs text-wl-neutral-300 truncate">
                            {c.email ?? "—"}
                          </div>
                          {c.phone && (
                            <div className="text-[10px] text-wl-text-tertiary mt-0.5">
                              {c.phone}
                            </div>
                          )}
                        </td>
                        ...
                        <td className="p-3 px-4 text-right font-semibold text-white">
