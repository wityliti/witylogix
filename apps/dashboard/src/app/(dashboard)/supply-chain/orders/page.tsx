              ...
              <Card key={batch.batchId}>
                <CardContent className="pt-6">
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <Badge variant={batch.status === 'completed' ? 'success' : batch.status === 'in_progress' ? 'warning' : 'default'}>
                      {batch.status}
                    </Badge>
                  </div>
                  <div className="w-full bg-wl-bg-elevated rounded-full h-2 mb-3">
                    <div
                  ...
                  <div className="flex items-center justify-between text-xs text-gray-400 mb-3">
                    ...
                    <span>{batch.completionRate.toFixed(0)}% complete</span>
                  </div>
