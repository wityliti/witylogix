...
export default function OrdersPage() {
  ...
  const { items: wavePlans } = useApiList<WavePlan>(
    "/api/v4/supply-chain/waves",
  );
  const { items: batchPicking } = useApiList<BatchPickingTask>(
    "/api/v4/supply-chain/batches",
  );
            ...
            {batchPicking.map((batch) => (
              <Card key={batch.batchId}>
                <CardContent className="pt-6">
                  ...
                  <div className="w-full bg-wl-bg-elevated rounded-full h-2 mb-4">
                    <div
