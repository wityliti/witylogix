                ...
                <CardContent className="pt-6">
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      ...
                      {batch.assignedTo && (
                        <p className="text-xs text-gray-300 mt-1">Assigned to: {batch.assignedTo}</p>
                      )}
                    </div>
                    <Badge variant={batch.status === 'completed' ? 'success' : batch.status === 'in-progress' ? 'warning' : 'default'}>
                      {batch.status}
                    </Badge>
                  </div>
