    ...
    >
      ...
      {trend !== undefined && (
        <div className="flex items-center gap-1.5 mt-2.5">
          ...
          {trendLabel && (
            <span className="text-xs text-white/25">{trendLabel}</span>
          )}
        </div>
      )}
    </div>
...
function MiniBarChart({
  ...
  data: Array<{ hour: number; [key: string]: number }>;
  dataKey: string;
  color: string;
  maxVal: number;
}) {
                      ...
                      <div className="flex-1">
                        ...
                        <div className="h-1.5 bg-white/[0.04] rounded-full overflow-hidden">
                          <div
                            ...
                            style={{
                              width: `${zone.pct}%`,
                              background: `linear-gradient(90deg, var(--wl-primary-400), var(--wl-primary-500))`,
                              opacity: 1 - i * 0.12,
                            }}
                          />
                        </div>
                      ...
                      <div
                        className={cn(
                          ...
                          i === 0
                            ...
                            : i === 1
                              ? "bg-wl-neutral-400/20 text-wl-neutral-300"
                              : i === 2
