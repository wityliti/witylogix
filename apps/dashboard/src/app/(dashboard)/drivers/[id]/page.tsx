...
export default function DriverDetailPage() {
  ...
  const scoreDelta = score.previousScore != null
    ...
    : null;
  const avgRating = metrics.avgCustomerRating ? parseFloat(metrics.avgCustomerRating) : null;
  const podPct = metrics.podCompliancePercent ? parseFloat(metrics.podCompliancePercent) : null;
          ...
          <div className="flex items-center gap-4 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <div className="flex flex-wrap items-center gap-3 mt-1.5">
                {(profileData?.phone || driver.phone) && (
                ...
                {profileData && (profileData.orders?.length ?? 0) > 0 && (
                  <span className="inline-flex items-center gap-1 text-xs text-amber-400/70">
                    ...
                    {profileData.orders!.length} active order{profileData.orders!.length !== 1 ? 's' : ''}
                  </span>
                )}
                {currentLat != null && (
              ...
              <div className="rounded-xl bg-wl-bg-surface border border-white/[0.06] p-5">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  {[
                    ...
                    { label: 'Vehicle Type',       value: profileData?.vehicleType ?? driver.vehicleType ?? '—' },
