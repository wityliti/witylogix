              ...
              <div className="rounded-xl bg-wl-bg-surface border border-white/[0.06] p-5">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  {[
                    {
                      label: "Avg Delivery Time",
                      value: `${metrics.avgDeliveryMinutes} min`,
                    },
                    {
                      label: "Late Deliveries",
                      value: metrics.lateCount.toString(),
                    },
                    {
                      label: "POD Missed",
                      value: metrics.podMissedCount.toString(),
                    },
                    {
                      label: "Incidents",
                      value: metrics.incidentCount.toString(),
                    },
                    {
                      label: "Vehicle Type",
                    ...
                    {
                      label: "Member Since",
                      value: new Date(driver.joinedAt).toLocaleDateString(
                        "en-GB",
                        { month: "short", year: "numeric" },
                      ),
                    },
