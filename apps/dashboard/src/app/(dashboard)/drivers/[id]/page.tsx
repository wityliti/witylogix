...
export default function DriverDetailPage() {
  ...
  const {
    ...
    error: scoreError,
    refetch,
  } = useApiQuery<DriverScoreResponse>(`/api/v4/driver-scoring/${driverId}`);
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-xl bg-wl-bg-surface border border-white/[0.06] p-5 space-y-4">
              ...
              <BreakdownRow
                ...
                value={scoreData.breakdown.onTimeScore}
                icon={Clock}
                accent="#34d399"
              />
              <BreakdownRow
                label="Customer Rating"
                value={scoreData.breakdown.customerRatingScore}
                icon={Star}
                accent="#fbbf24"
              />
              <BreakdownRow
                label="POD Compliance"
                value={scoreData.breakdown.podComplianceScore}
                icon={Camera}
                accent="#60a5fa"
              />
              <BreakdownRow
                label="Route Efficiency"
                value={scoreData.breakdown.routeEfficiencyScore}
                icon={Route}
                accent="#818cf8"
              />
              <BreakdownRow
                label="Reliability"
                value={scoreData.breakdown.reliabilityScore}
                icon={ShieldCheck}
                accent="#a78bfa"
              />
            </div>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {[
                {
                  label: "Deliveries",
                  value: scoreData.metrics.totalDeliveries.toLocaleString(),
                  icon: BarChart3,
                  accent: "#818cf8",
                },
                {
                ...
                },
                {
                  ...
                  icon: Star,
                  accent: "#fbbf24",
                  suffix: avgRating != null ? "/ 5" : undefined,
                },
                {
                  label: "POD Rate",
                  value: podPct != null ? `${podPct.toFixed(1)}%` : "—",
                  icon: Camera,
                  accent: "#60a5fa",
                },
                ...
                <div
                  key={label}
                  className="relative overflow-hidden rounded-xl bg-wl-bg-surface border border-white/[0.06] p-4 group hover:border-white/[0.12] transition-all"
                >
                  <div
                  ...
                  <div className="flex items-baseline gap-1">
                    <span className="text-xl font-bold font-mono text-white/85">
                      {value}
                    </span>
                    {suffix && (
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-white/70">
                      {profileData.vehicleType || "Unknown"}
                    </p>
