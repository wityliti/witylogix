      ...
      <CardContent className="p-5">
        <div className="flex items-start justify-between mb-4 pb-4 border-b border-wl-border-subtle">
          <div className="flex items-start gap-3 flex-1 min-w-0">
            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center flex-shrink-0">
              <span className="text-sm font-semibold text-wl-text-primary">{initials}</span>
            </div>
        ...
        <div className="grid grid-cols-3 gap-3 mb-4 pb-4 border-b border-wl-border-subtle">
          <div>
            ...
            <div className="text-sm font-semibold text-wl-text-primary">{driver._count.orders}</div>
          </div>
          <div>
            <div className="text-xs text-wl-text-secondary mb-1">Vehicle</div>
            <div className="text-xs font-medium text-wl-text-primary flex items-center gap-1">
          ...
          <div>
            ...
            <div className="text-sm font-semibold text-wl-text-primary">{driver.vehiclePlate || '—'}</div>
          </div>
        </div>
