...
const LocationsOverviewMap = dynamic(
  () =>
    import("./components/locations-overview-map").then(
      (m) => m.LocationsOverviewMap,
    ),
  { ssr: false },
);
...
function LocationDetailPanel({
  ...
  return (
    <div
      className={cn(
        "flex flex-col gap-4 rounded-xl border border-wl-border-default bg-wl-bg-surface p-5",
        "overflow-y-auto max-h-[calc(100vh-200px)]",
      )}
    >
      <div className={cn("flex items-start justify-between")}>
        <div>
          <h3 className={cn("text-base font-bold text-white")}>
            {location.name}
          </h3>
        ...
        <button
          ...
          className={cn(
            "text-wl-text-secondary hover:text-white transition-colors text-lg font-sans",
          )}
        >
          ✕
        </button>
      ...
      <div>
        ...
        <div className={cn("grid grid-cols-2 gap-3")}>
          ...
          <div>
            ...
            <div
              className={cn("text-lg font-bold font-mono text-wl-neutral-300")}
            >
      ...
      {location.operatingHours && (
        <>
          ...
          <div>
            <div
              className={cn(
                "text-xs font-semibold text-wl-text-secondary uppercase mb-3 tracking-wider",
              )}
            >
              Operating Hours
            </div>
              ...
              <tbody>
                {Object.entries(location.operatingHours).map(([day, hours]) => (
                  ...
                  >
                    <td
                      className={cn(
                        "p-2 pr-3 text-wl-neutral-300 font-medium whitespace-nowrap",
                      )}
                    >
                      {day}
                    </td>
      ...
      <Header
        ...
        actions={
          <div className={cn("flex gap-2 items-center")}>
            <div
              className={cn(
                "flex rounded-lg border border-[#1e1e2e] overflow-hidden",
              )}
            >
      ...
      <div className={cn("p-6")}>
        ...
        {viewMode === "grid" && (
          ...
          >
            <div
              className={cn(
                "grid grid-cols-[repeat(auto-fill,minmax(280px,1fr))] gap-4 content-start",
              )}
            >
              {filtered.map((location, i) => (
                <Card
                  ...
                  className={cn(
                    "cursor-pointer relative overflow-hidden flex flex-col p-5",
                  )}
                  style={{
                ...
                >
                  ...
                  <div className={cn("flex justify-between items-start mb-3")}>
                    <div className={cn("flex-1 min-w-0 mr-2")}>
                  ...
                  <div className={cn("text-sm text-wl-text-secondary mb-3")}>
                  ...
                  <div className={cn("grid grid-cols-3 gap-2 text-center")}>
                    <div>
                      ...
                      <div
                        className={cn(
                          "text-sm font-bold font-mono text-blue-400",
                        )}
                      >
                        {location.activeShipments}
                      </div>
                    ...
                    <div>
                      ...
                      <div
                        className={cn(
                          "text-sm font-bold font-mono text-emerald-500",
                        )}
                      >
                        {location.totalProcessed}
                      </div>
                    ...
                    <div>
                      ...
                      <div
                        className={cn(
                          "text-sm font-bold font-mono text-wl-neutral-300",
                        )}
                      >
                        {location.avgPrepTime}m
                      </div>
              ...
              {filtered.length === 0 && (
                <div className={cn("col-span-full text-center py-12")}>
