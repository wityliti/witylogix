...
function LocationDetailPanel({
  ...
  return (
    <div
      className={cn(
        "bg-wl-bg-surface border border-wl-border-default rounded-xl p-5 flex flex-col gap-4",
      )}
    >
      <div className={cn("flex items-start justify-between gap-2")}>
        ...
        <button
          onClick={onClose}
          className={cn(
            "text-wl-text-secondary cursor-pointer text-lg font-sans bg-transparent border-none",
          )}
        >
          ✕
        </button>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className={cn("grid grid-cols-2 gap-3")}>
                      <div>
                        <div
                          className={cn("text-xs text-wl-text-secondary mb-1")}
                        >
                          Active Shipments
                        </div>
                        <div
                          className={cn(
                            "text-lg font-bold font-mono text-blue-400",
                          )}
                        >
                      ...
                      <div>
                        ...
                        <div
                          className={cn(
                            "text-lg font-bold font-mono text-emerald-500",
                          )}
                        >
                      ...
                      <div>
                        ...
                        <div
                          className={cn(
                            "text-lg font-bold font-mono text-wl-neutral-300",
                          )}
                        >
                                ...
                                >
                                  ...
                                  <td
                                    className={cn(
                                      "p-2",
                                      hours.open === "closed"
                                        ? "text-wl-text-secondary font-sans"
                  ...
                  <div>
                    ...
                    <div
                      className={cn(
                        "text-xs font-mono text-wl-text-tertiary text-center py-2",
                      )}
                    >
