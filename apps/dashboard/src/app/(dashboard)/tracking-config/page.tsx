              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex gap-2 items-center">
                    ...
                    <input
                      ...
                      value={config.primaryColor}
                      onChange={(e) => update("primaryColor", e.target.value)}
                      className="flex-1 px-2 py-1.5 bg-wl-bg-elevated border border-wl-border-default rounded text-wl-text-secondary text-xs font-mono focus:outline-none focus:border-blue-500/50"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-wl-bg-elevated border border-wl-border-default rounded text-wl-text-secondary text-xs focus:outline-none focus:border-blue-500/50"
                  />
