...
const DRIVER_STATUS_CONFIG: Record<string, { bg: string; border: string; text: string; dot: string; label: string }> = {
  AVAILABLE: { bg: 'bg-wl-success-500/20', border: 'border-wl-success-500/50', text: 'text-wl-success-400', dot: 'var(--wl-success-500)', label: 'AVAILABLE' },
  ON_ROUTE: { bg: 'bg-wl-info-500/20', border: 'border-wl-info-500/50', text: 'text-wl-info-400', dot: 'var(--wl-info-500)', label: 'EN ROUTE' },
  ON_BREAK: { bg: 'bg-wl-warning-500/20', border: 'border-wl-warning-500/50', text: 'text-wl-warning-400', dot: 'var(--wl-warning-500)', label: 'ON BREAK' },
