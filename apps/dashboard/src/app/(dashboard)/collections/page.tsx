        ...
        <div className="flex gap-4 mb-5 items-center flex-wrap">
          ...
          <div className="flex-1 min-w-[300px] max-w-[400px] relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-wl-bg-elevated border border-wl-border-default rounded-lg text-white text-sm placeholder-gray-500 focus:outline-none focus:border-wl-info-500 focus:ring-1 focus:ring-wl-info-500/30 transition-colors duration-200"
            />
          </div>
                ...
                {paginatedItems.map((collection, idx) => (
                  <>
                    <tr key={collection.id} className={cn(
                      ...
                      <td className="p-3 px-4 text-center cursor-pointer text-wl-text-secondary" onClick={() => setExpandedCollection(expandedCollection === collection.id ? null : collection.id)}>
