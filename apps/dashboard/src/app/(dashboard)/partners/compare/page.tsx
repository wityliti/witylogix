...
function integrationToCourier(i: InstalledIntegration): Courier {
  ...
  return {
    ...
    coverageAreas: typeof cfg.coverageAreas === "number" ? cfg.coverageAreas : 30,
    successRate: typeof cfg.successRate === "number" ? cfg.successRate : 95.0,
    rating: typeof cfg.rating === "number" ? cfg.rating : 4.5,
  ...
  return (
    <div className="flex flex-col gap-6 p-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-gray-300">Select up to 4 couriers to compare side-by-side</p>
      </div>
      ...
      {couriers.length === 0 ? (
        <Card className="py-12 text-center">
          <div className="flex flex-col items-center gap-2">
            <p className="text-gray-300">No courier integrations installed yet.</p>
            <Button
              variant="primary"
              size="sm"
                ...
                <CardContent className="pt-0">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-white font-medium">{courier.successRate}%</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      {comparisonCouriers.length === 0 && couriers.length > 0 && (
        <Card className="py-12 text-center">
          <div className="flex flex-col items-center gap-2">
            <p className="text-gray-300">Select couriers above to compare them</p>
          </div>
        </Card>
      )}
    </div>
