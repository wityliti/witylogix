...
function DetailModal({ log, onClose }: { log: ApiNotificationLog; onClose: () => void }) {
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50" onClick={onClose}>
      <Card
        className="border border-wl-border-strong bg-wl-bg-surface w-full max-w-lg mx-4 max-h-[80vh] overflow-y-auto"
      ...
      >
        ...
        <CardContent className="space-y-4 text-sm">
          ...
          <button
            onClick={onClose}
            className="w-full mt-2 px-4 py-2 bg-wl-bg-elevated text-white rounded-lg hover:bg-wl-bg-overlay transition-colors text-sm"
          >
            Close
          </button>
        </CardContent>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <Card key={label} className="border border-wl-border-strong bg-wl-bg-surface">
        ...
        {/* Filters */}
        <Card className="border border-wl-border-strong bg-wl-bg-surface">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 bg-wl-bg-root text-wl-text-primary border border-wl-border-strong rounded-md text-sm focus:outline-none focus:border-wl-border-default"
                >
              ...
              <div>
                ...
                <Input
                  ...
                  className="bg-wl-bg-root border-wl-border-strong text-wl-text-primary"
                />
              </div>
              <div>
            ...
            {loading ? (
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <TableHeader>
                    <TableRow className="border-b border-wl-border-strong bg-wl-bg-root/50">
                      <TableHead className="text-xs uppercase tracking-wide text-wl-text-tertiary py-3 px-4">Timestamp</TableHead>
                      <TableHead className="text-xs uppercase tracking-wide text-wl-text-tertiary py-3 px-4">Recipient</TableHead>
                      <TableHead className="text-xs uppercase tracking-wide text-wl-text-tertiary py-3 px-4">Channel</TableHead>
                      <TableHead className="text-xs uppercase tracking-wide text-wl-text-tertiary py-3 px-4">Event</TableHead>
                      <TableHead className="text-xs uppercase tracking-wide text-wl-text-tertiary py-3 px-4">Order</TableHead>
                      <TableHead className="text-xs uppercase tracking-wide text-wl-text-tertiary py-3 px-4">Status</TableHead>
                  ...
                  <TableBody>
                    {logs.map((log) => (
                      <TableRow
                        key={log.id}
                        className="border-b border-wl-border-strong/50 hover:bg-wl-bg-root/50 transition-colors"
                      >
