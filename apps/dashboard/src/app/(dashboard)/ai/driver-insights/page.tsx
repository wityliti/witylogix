...
function tierColor(tier: string) {
  switch (tier) {
    ...
    case 'silver':   return { bg: 'bg-wl-neutral-400/15',   text: 'text-wl-text-secondary',   border: 'border-wl-border-subtle/30' };
          ...
          <div className="rounded-xl bg-wl-bg-surface border border-white/[0.06] overflow-hidden">
            <div className="flex items-center justify-between px-5 py-4 border-b border-white/[0.06]">
              ...
              <div className="flex items-center gap-4 text-[11px] text-white/30">
                ...
                <span className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded-full bg-wl-bg-overlay" />Bronze</span>
              </div>
            </div>
            {mapDrivers.length === 0 ? (
