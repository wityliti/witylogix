      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-[repeat(auto-fit,minmax(400px,1fr))] mb-6">
        ...
        <div className="bg-wl-bg-surface border border-wl-border-default rounded-lg p-6">
          ...
          <div className="mb-4">
            ...
            <textarea
              className="w-full px-3 py-2.5 bg-wl-bg-root border border-wl-border-default rounded text-wl-text-secondary text-sm min-h-20 font-inherit box-border focus:outline-none focus:border-blue-500"
