    ...
    return (
      <div className="min-h-screen bg-wl-bg-root p-6 text-white flex items-center justify-center">
        <div className="bg-wl-bg-surface border border-wl-border-default rounded-lg p-8 max-w-md w-full text-center">
          ...
          <p className="text-wl-text-secondary text-sm mb-6">
    ...
    <div className="min-h-screen bg-wl-bg-root p-6 text-white">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-[repeat(auto-fit,minmax(400px,1fr))] mb-6">
        ...
        <div className="bg-wl-bg-surface border border-wl-border-default rounded-lg p-6">
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium text-wl-neutral-300 mb-2">
              Customer Type
            </label>
            <div className="flex gap-5 mb-4">
              {[
                ...
                <label
                  key={idx}
                  className="flex items-center gap-2 cursor-pointer text-sm text-wl-neutral-300"
                >
                  <input
                    type="radio"
                    checked={opt.checked}
          ...
          {!isNewCustomer ? (
            <div className="mb-4 relative">
              <label className="block text-sm font-medium text-wl-neutral-300 mb-1.5">
                Search Customer
              </label>
              <input
                type="text"
        ...
        <div className="bg-wl-bg-surface border border-wl-border-default rounded-lg p-6">
          ...
          <div className="mb-5">
            <label className="block text-sm font-medium text-wl-neutral-300 mb-2.5">
              Payment Method
            </label>
