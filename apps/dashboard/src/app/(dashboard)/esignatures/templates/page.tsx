              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-wl-border-default">
                    ...
                    <th className="text-left py-3 px-4 font-medium text-wl-text-secondary">Category</th>
                    <th className="text-left py-3 px-4 font-medium text-wl-text-secondary">Documents</th>
                    <th className="text-left py-3 px-4 font-medium text-wl-text-secondary">Fields</th>
                    <th className="text-left py-3 px-4 font-medium text-wl-text-secondary">Usage</th>
                    <th className="text-left py-3 px-4 font-medium text-wl-text-secondary">Version</th>
                    <th className="text-left py-3 px-4 font-medium text-wl-text-secondary">Last Used</th>
                  </tr>
                </thead>
                <tbody>
                  {templates.map((tpl) => (
                    ...
                    >
                      ...
                      <td className="py-3 px-4 text-wl-text-secondary">{tpl.documentCount}</td>
                      <td className="py-3 px-4 text-wl-text-secondary">{tpl.signatureFields}</td>
                      <td className="py-3 px-4 text-wl-text-secondary">{tpl.usageCount}x</td>
                      <td className="py-3 px-4 text-wl-text-secondary">v{tpl.version}</td>
        ...
        {templates.map((tpl) => (
          ...
          >
            ...
            <CardContent className="pt-4">
              ...
              <div className="grid grid-cols-3 gap-2 text-xs text-wl-text-secondary mb-3">
                <div>
    ...
    <Card className="mt-6 bg-wl-bg-surface border-wl-border-default">
      ...
      <CardContent className="pt-6">
        <div className="grid grid-cols-3 gap-6">
          {/* General Info */}
          <div>
            <h3 className="text-sm font-semibold text-wl-text-secondary mb-3">General</h3>
            <div className="space-y-3 text-sm">
              <div>
                <p className="text-wl-text-secondary text-xs">Category</p>
          ...
          {/* Usage Stats */}
          <div>
            <h3 className="text-sm font-semibold text-wl-text-secondary mb-3">Usage</h3>
        ...
        <CardContent className="pt-6">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              <label className="text-sm font-medium text-wl-text-secondary">Filter:</label>
            ...
            <div className="flex items-center gap-2 border-l border-wl-border-default pl-4">
              <label className="text-sm font-medium text-wl-text-secondary">View:</label>
              <button
      ...
      {filteredTemplates.length > 0 ? (
        ...
        <Card className="bg-wl-bg-surface border-wl-border-default text-center py-12">
          <CardContent className="space-y-4">
            <FileText className="mx-auto text-wl-text-tertiary" size={48} />
