  ...
  return (
    <div
      ...
      className={cn(
        ...
        isSelected &&
          "border-blue-500 ring-1 ring-blue-500/25 bg-wl-bg-elevated",
      )}
    >
      {/* Header row */}
      ...
      {/* Customer */}
      <p className="text-xs text-wl-text-secondary font-medium truncate mb-1">
        {order.customerName}
      </p>
      ...
      <div className="flex items-start gap-1.5 mb-2">
        ...
        <p className="text-xs text-wl-text-secondary line-clamp-2">
          {order.address}
        </p>
      </div>
      ...
      {isAssigning ? (
        ...
        >
          <p className="text-[11px] text-wl-text-secondary font-medium uppercase tracking-wider">
            Assign driver
          </p>
          <div className="max-h-28 overflow-y-auto space-y-1">
            {availableDrivers.length === 0 ? (
              <p className="text-xs text-wl-text-tertiary py-2 text-center">
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-2">
        <p className="text-sm font-semibold text-wl-text-primary truncate flex-1">
          {driver.name}
        </p>
        <div
          className={cn(
      ...
      <div className="text-xs text-wl-text-secondary flex items-center gap-1 mb-1">
        ...
        {driver.vehiclePlate && (
          <span className="text-wl-text-tertiary font-mono">
            · {driver.vehiclePlate}
          </span>
        )}
      </div>
      ...
      <div className="flex justify-between text-[11px] text-wl-text-tertiary">
        ...
        {driver.location && (
          <span
            className="text-wl-text-tertiary truncate max-w-24"
...
function SkeletonCard({ height = "h-32" }: { height?: string }) {
  return (
    <div className={cn(height, "bg-wl-bg-elevated rounded-lg animate-pulse")} />
  );
}
        ...
        <div className="h-14 px-5 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-base font-bold text-wl-text-primary tracking-tight">
                Dispatch Center
              </h1>
            </div>
          </div>
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  className={cn(
                    ...
                    sortType === "priority"
                      ? "bg-blue-600 text-wl-text-primary"
        ...
        <aside className="col-span-3 flex flex-col bg-wl-bg-surface overflow-hidden min-h-0">
          ...
          <div className="flex-shrink-0 px-4 py-2.5 border-t border-wl-border-default bg-wl-bg-elevated/30">
            <div className="grid grid-cols-4 gap-1 text-center">
              <div>
                <div className="text-sm font-bold text-wl-text-primary">
                  {driverStats.total}
                </div>
              ...
              <div>
                <div className="text-sm font-bold text-wl-text-tertiary">
                  {driverStats.offline}
                </div>
            ...
            <div className="grid grid-cols-5 gap-0 w-full">
              {[
                ...
                >
                  ...
                  <div>
                    <p className="text-[11px] font-semibold text-wl-text-secondary leading-tight">
                      {stat.label}
                    </p>
                  </div>
                </div>
