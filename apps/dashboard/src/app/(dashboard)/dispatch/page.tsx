  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-2">
        <p className="text-sm font-semibold text-white truncate flex-1">{driver.name}</p>
        ...
        <div className="h-14 px-5 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-base font-bold text-white tracking-tight">Dispatch Center</h1>
            </div>
          </div>
          ...
          <div className="flex-shrink-0 px-4 py-3 border-b border-zinc-800 bg-zinc-800/30">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-semibold text-white uppercase tracking-wider">Queue</span>
                {!ordersLoading && (
