    ...
    >
      <div className="flex items-start justify-between mb-2">
        <div className="flex-1 min-w-0">
          <p className="font-semibold text-wl-text-primary text-sm truncate">{delivery.orderId}</p>
  ...
  return (
    <div className="flex flex-col h-screen bg-wl-bg-root overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden gap-0 min-h-0">
        ...
        <div className="flex flex-col w-80 flex-shrink-0 bg-wl-bg-surface border-r border-wl-border-default overflow-hidden">
          {/* Header */}
          <div className="flex-shrink-0 flex items-center justify-between px-4 py-3 border-b border-wl-border-default bg-wl-bg-elevated/30">
            <div className="flex items-center gap-2">
              <h2 className="text-sm font-semibold text-wl-text-primary">Pending Deliveries</h2>
            ...
            <div className="flex items-center gap-2">
              <Button
                variant="ghost"
                size="sm"
                className="h-7 w-7 p-0 text-wl-text-secondary hover:text-wl-text-primary"
        ...
        <div className="flex-1 flex flex-col overflow-hidden min-h-0 min-w-0">
          ...
          <div className="flex-1 min-h-0 relative">
            ...
            <div className="absolute top-0 left-0 right-0 z-10 flex items-center justify-between px-4 py-2 bg-wl-bg-surface/90 border-b border-wl-border-default backdrop-blur-sm">
              ...
              <div className="flex items-center gap-3 text-[11px] text-wl-text-secondary">
                ...
                <span>
                  <span className="text-wl-text-primary font-semibold">{stats.inTransitCount}</span>{" "}
                  in transit
                </span>
                {selectedDelivery && (
                  <button
          ...
          {selectedDelivery && (
            <div className="flex-shrink-0 bg-wl-bg-surface border-t border-wl-border-default max-h-56 overflow-y-auto">
              <div className="p-4">
                <div className="flex items-start justify-between mb-3">
                  <div>
                    <h3 className="text-sm font-semibold text-wl-text-primary">Delivery Details</h3>
