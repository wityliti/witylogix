              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-wl-border-default bg-wl-bg-elevated">
                    <th className="text-left px-4 py-3 text-xs font-semibold text-wl-text-secondary uppercase tracking-wider">
                      Shipment #
                    </th>
                    <th className="text-left px-4 py-3 text-xs font-semibold text-wl-text-secondary uppercase tracking-wider">
                      Customer
                    ...
                    <th className="text-center px-4 py-3 text-xs font-semibold text-wl-text-secondary uppercase tracking-wider">
                      Status
                    </th>
                    <th className="text-left px-4 py-3 text-xs font-semibold text-wl-text-secondary uppercase tracking-wider">
                      Scheduled
