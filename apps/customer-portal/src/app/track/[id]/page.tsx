...
export default function TrackDeliveryPage({
  ...
  const {
    data: trackingEnvelope,
    loading,
    error,
    refetch,
  } = useQuery<TrackingEnvelope>(ROUTES.TRACKING_BY_TOKEN(trackingToken));
  ...
  const isFailed = ["FAILED", "CANCELLED", "RETURNED"].includes(
    tracking.status,
  );
    ...
    <div className="page-container animate-fade-in">
      <div className="page-header">
        ...
        <p className="page-subtitle">
          Order{" "}
          <span className="mono">
            {tracking.externalOrderNumber ??
              `#${tracking.id.slice(-8).toUpperCase()}`}
          </span>
        </p>
      </div>
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          >
            ...
            <div className="flex items-start gap-2 mt-3 text-sm text-wl-text-secondary">
              <MapPin
                size={14}
                className="mt-0.5 flex-shrink-0 text-wl-text-tertiary"
              />
              <span>
            ...
            <div className="section-card">
              ...
              {tracking.proofOfDelivery.deliveredAt && (
                <p className="text-xs text-wl-text-tertiary mt-1">
                  At{" "}
                  {format(
                    new Date(tracking.proofOfDelivery.deliveredAt),
                    "PPp",
                  )}
                </p>
              )}
          ...
          {!isDelivered && !isFailed && (
            <ManageDeliveryPanel
              ...
              initialPreferences={
                tracking.deliveryPreferences
                  ? {
                      ...
                      contactPref:
                        (tracking.deliveryPreferences
                          .contactPref as ContactPref | null) ?? null,
                    }
                  : undefined
              }
              ...
              slotsLocked={["OUT_FOR_DELIVERY", "ARRIVED"].includes(
                tracking.status,
              )}
            />
          )}
          ...
          {tracking.driver && (
            <div className="section-card">
              ...
              <p className="text-xs text-wl-text-tertiary">
                Use the Manage Delivery panel below to set your contact
                preference.
              </p>
            </div>
          )}
