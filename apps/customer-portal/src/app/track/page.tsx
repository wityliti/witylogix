  ...
  return (
    <div className="page-container animate-fade-in">
      <div className="page-header">
        ...
        <p className="page-subtitle">Enter your tracking token to see real-time delivery status</p>
      </div>
      ...
      <div className="max-w-xl stagger-1">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={cn('input w-full pl-9', error && 'border-wl-error-500')}
                autoComplete="off"
                autoFocus
              />
            </div>
            {error && (
              <p className="mt-1 text-sm text-wl-error-500">{error}</p>
            )}
            <p className="mt-2 text-xs text-wl-text-tertiary">
              Your tracking token can be found in your delivery confirmation email or on your order
              details page.
            </p>
          </div>
        ...
        <div className="section-card mt-4 stagger-2">
          <div className="flex items-start gap-3">
            <Package size={18} className="text-wl-primary-500 flex-shrink-0 mt-0.5" />
            <div>
              <p className="text-sm font-semibold text-wl-text-primary">Where is my token?</p>
