...
describe('SupportPage', () => {
  ...
  it('renders page subtitle', () => {
    render(<SupportPage />);
    expect(screen.getByText('Get help with your deliveries and account')).toBeInTheDocument();
  });
  ...
  it('shows FAQ questions by default', () => {
    render(<SupportPage />);
    expect(screen.getByText(/can i reschedule my delivery/i)).toBeInTheDocument();
  });
