...
export declare function getCachedRate(
  shopId: string,
  originZip: string,
  destZip: string,
  weightBucket: number,
): Promise<string | null>;
export declare function setCachedRate(
  shopId: string,
  originZip: string,
  destZip: string,
  weightBucket: number,
...
export declare function updateDriverGeo(
  driverId: string,
  longitude: number,
  latitude: number,
): Promise<void>;
export declare function findNearbyDriversGeo(
  longitude: number,
  latitude: number,
  radiusKm: number,
  count?: number,
