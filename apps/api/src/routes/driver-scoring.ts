  ...
  fastify.get(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      ...
      try {
        ...
        if (!score) {
          throw new ValidationError(
            "Unable to calculate score for this driver",
          );
        }
        ...
        throw new ValidationError(
          `Failed to fetch driver score: ${(error as Error).message}`,
        );
      }
    },
  );
  ...
  fastify.get(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      ...
      try {
        ...
        throw new ValidationError(
          `Failed to fetch score history: ${(error as Error).message}`,
        );
      }
    },
  );
