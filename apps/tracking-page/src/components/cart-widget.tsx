...
export function CartWidget({
  ...
  const canProceedToComplete = !!selectedDate && !!selectedSlot && !!selectedRate
              ...
              >
                ...
                <div
                  style={{
                    ...
                    height: '40px',
                    borderRadius: '50%',
                    backgroundColor: isCompleted || isActive ? primaryColor : secondaryColor,
                    ...
                    boxShadow: isActive ? `0 0 0 4px ${primaryColor}30` : 'none',
                ...
                <span
                  style={{
                    fontSize: '12px',
                    fontWeight: '500',
                    color: isActive ? primaryColor : isDarkTheme ? '#999999' : '#6b7280',
                    textAlign: 'center',
            ...
            <div style={{ textAlign: 'center', padding: '40px 20px' }}>
              ...
              >
                <button
                  ...
                  onMouseEnter={(e) => {
                    ;(e.target as HTMLElement).style.backgroundColor = lightPrimary
                  }}
                  onMouseLeave={(e) => {
