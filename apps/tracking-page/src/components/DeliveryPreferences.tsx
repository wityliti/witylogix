  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <p style={styles.subtitle}>Customize how you'd like to receive your package</p>

        {/* Safe Place Selection */}
        <div style={styles.section}>
          <h3 style={styles.sectionTitle}>Where to leave package?</h3>
          <p style={styles.sectionDescription}>Select your preferred safe place</p>
          <div style={styles.safePlacesGrid}>
            {safePlaces.map(place => (
              ...
              >
                ...
                <span style={styles.safePlaceLabel}>{place.label.split(' ').slice(1).join(' ')}</span>
              </button>
            ))}
          </div>
        </div>
        ...
        <div style={styles.section}>
          ...
          <p style={styles.sectionDescription}>Add special instructions for the driver</p>
          <textarea
        ...
        <div style={styles.section}>
          ...
          <p style={styles.sectionDescription}>Authorize delivery to trusted neighbor</p>
          <div style={styles.toggleContainer}>
            <button
              onClick={handleNeighborToggle}
              style={{
                ...styles.toggleButton,
                ...(preferences.leaveWithNeighbor ? styles.toggleButtonActive : {}),
              }}
            >
              <span style={styles.toggleSwitch} />
            </button>
