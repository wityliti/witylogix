    ...
    >
      ...
      >
        {calendarDays.map((day) => {
          ...
          const shouldDisable = !day.isCurrentMonth || isPast || day.isBlocked || !day.isAvailable
          ...
          return (
            <button
              ...
              style={{
                padding: '8px',
                borderRadius: '8px',
                border: day.isSelected ? `2px solid ${primaryColor}` : `1px solid ${borderColor}`,
                backgroundColor: day.isSelected
                  ? primaryColor
                  : day.isAvailable && day.isCurrentMonth && !isPast
                    ? secondaryColor
                    : disabledColor,
                color: day.isSelected ? '#ffffff' : day.isCurrentMonth && !isPast && day.isAvailable ? textColor : isDarkTheme ? '#666666' : '#9ca3af',
              ...
              onMouseLeave={(e) => {
                if (isClickable) {
                  ;(e.target as HTMLElement).style.backgroundColor = day.isSelected ? primaryColor : secondaryColor
                  ;(e.target as HTMLElement).style.color = day.isSelected ? '#ffffff' : textColor
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          />
          <span style={{ fontSize: '13px', color: isDarkTheme ? '#999999' : '#6b7280' }}>Unavailable/Past</span>
        </div>
      </div>
