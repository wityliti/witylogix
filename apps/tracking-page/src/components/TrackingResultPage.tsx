...
function formatDeliveryAddress(
  addr: TrackingData["response"]["deliveryAddress"],
): string {
  return [addr.line1, addr.city, addr.province, addr.postalCode]
    .filter(Boolean)
    .join(", ");
}
...
export function TrackingResultPage({
    ...
    >
      ...
      {!isMobile && (
        ...
        >
          ...
          <div style={{ textAlign: "right" }}>
            <div
              style={{ fontSize: "13px", fontWeight: "600", color: DARK_TEXT }}
            >
              {shop.name}
            </div>
            {orderNumber && (
      ...
      >
        <div
          style={{
            fontSize: "52px",
            marginBottom: "12px",
            animation: isLive ? "tp-pulse 2s ease-in-out infinite" : "none",
          }}
        >
      ...
      {proofOfDelivery && isDelivered && (
        ...
        >
          ...
          {proofOfDelivery.photoUrls &&
            proofOfDelivery.photoUrls.length > 0 && (
  ...
  if (isMobile) {
    return (
      <div
        style={{ width: "100%", minHeight: "100vh", backgroundColor: BG_COLOR }}
      >
        {/* Sticky header */}
        <div
          style={{
