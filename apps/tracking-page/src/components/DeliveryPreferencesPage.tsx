    ...
    >
      ...
      >
        ...
        <div>
          ...
          />
          <p
            style={{ fontSize: "12px", color: "#6b7280", margin: "6px 0 0 0" }}
          >
                ...
                style={{
                  ...
                  border:
                    form.contactPref === opt.value
                      ...
                      : "1px solid #e5e7eb",
                  backgroundColor:
                    form.contactPref === opt.value ? "#f0f9ff" : "white",
                  cursor: "pointer",
                  fontSize: "13px",
                  fontWeight: "500",
                  color:
                    form.contactPref === opt.value ? BRAND_BLUE : "#374151",
                }}
              >
                <input
                  type="radio"
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setForm({ ...form, rescheduleDate: e.target.value })
            }
            style={inputStyle}
          />
        </div>
        ...
        <div style={{ display: "flex", gap: "12px", marginTop: "8px" }}>
          ...
          <button
            ...
            style={{
              flex: 1,
              backgroundColor: saving ? "#93c5fd" : BRAND_GREEN,
              color: "white",
              padding: "12px 16px",
              borderRadius: "8px",
