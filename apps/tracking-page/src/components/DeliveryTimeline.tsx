    ...
    <div style={styles.container}>
      ...
      <div style={styles.timelineWrapper}>
        {displayEvents.map((event, index) => {
          const isCurrent =
            event.isCurrent || index === displayEvents.length - 1;
        ...
        <div style={styles.infoCard}>
          ...
          {currentStatus === "Delivered" ? (
            <p style={styles.infoText}>
              Your package has been delivered. Check for it at your delivery
              location.
            </p>
          ) : currentStatus === "Out for Delivery" ? (
            <p style={styles.infoText}>
              Your driver is on the way! You'll receive a notification when
              they're nearby.
            </p>
          ) : (
            <p style={styles.infoText}>
              Track your delivery in real-time. We'll notify you of every
              update.
            </p>
          )}
        </div>
