...
const TrackingSearch: React.FC<TrackingSearchProps> = ({
  ...
  const [searchType, setSearchType] = useState<"tracking" | "order" | "phone">(
    "tracking",
  );
      ...
      <div style={styles.card}>
        ...
        <div style={styles.header}>
          ...
          <p style={styles.subtitle}>
            Enter your tracking or order number to see delivery status
          </p>
        </div>
        ...
        <div style={styles.searchContainer}>
          <div style={styles.inputWrapper}>
            <input
              ...
              placeholder={
                searchType === "tracking"
                  ? "Enter tracking number (e.g., WTX123456789)"
                  : searchType === "order"
