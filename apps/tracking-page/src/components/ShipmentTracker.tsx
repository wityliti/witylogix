    ...
    return (
      ...
      >
        <div style={{ textAlign: "center" }}>
          ...
          />
          <p style={{ color: LIGHT_TEXT, margin: 0, fontSize: "14px" }}>
    ...
    >
      ...
      {isLive && (
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          />
          <span
            style={{ fontSize: "13px", color: BRAND_GREEN, fontWeight: "600" }}
          >
          ...
          <p style={{ fontSize: "13px", color: "#166534", margin: 0 }}>
            ...
            {data.proofOfDelivery.deliveredAt && (
              <>
                {" "}
                on{" "}
                {new Date(data.proofOfDelivery.deliveredAt).toLocaleDateString(
                  "en-US",
