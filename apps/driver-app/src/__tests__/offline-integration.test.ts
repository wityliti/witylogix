...
async function getPending() {
  return [...eventStore.values()]
    ...
    .sort(
      (a, b) =>
        a.sync_priority - b.sync_priority ||
        a.device_captured_at - b.device_captured_at,
    );
}
