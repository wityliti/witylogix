...
import { View, Text, StyleSheet, SafeAreaView, ScrollView, TouchableOpacity, ActivityIndicator, Alert, Linking, FlatList, } from 'react-native';
...
const RouteDetailScreen = () => {
    ...
    const renderStop = ({ item }) => (<View style={styles.stopItem}>
      ...
      <TouchableOpacity style={styles.navButton} onPress={() => handleNavigate(item.latitude, item.longitude)}>
    ...
    return (<SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.stopsContainer}>
          ...
          <FlatList data={routeDetail.stops} keyExtractor={(item) => item.id} renderItem={renderStop} scrollEnabled={false}/>
        </View>

        <View style={styles.actionContainer}>
          {routeDetail.status === 'pending' && (<TouchableOpacity style={styles.primaryButton} onPress={handleStartRoute}>
              <Text style={styles.buttonText}>Start Route</Text>
            </TouchableOpacity>)}
          {routeDetail.status === 'in_progress' && (<TouchableOpacity style={styles.primaryButton} onPress={handleCompleteRoute}>
...
//# sourceMappingURL=RouteDetailScreen.js.map