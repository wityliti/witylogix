...
const ProfileScreen = () => {
    ...
    return (<SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {profile?.vehicle && (<View style={styles.section}>
        ...
        {profile?.todayStats && (<View style={styles.section}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.settingRow}>
            ...
            <Switch value={notificationsEnabled} onValueChange={setNotificationsEnabled} trackColor={{ false: '#ddd', true: '#81c784' }} thumbColor={notificationsEnabled ? '#008060' : '#999'}/>
          </View>
        </View>
