  ...
  return (
    <div className="max-w-4xl">
      ...
      <div className="bg-[#14141f] border border-gray-800 rounded p-6 text-sm text-gray-500">
        ...
        <p>
          Phase 2 tails <code>bench.audit.log</code> from each installation and
          surfaces it here. Each installation streams its audit JSONL into a
          central Redis stream which this page queries via an SSE endpoint.
        </p>
      </div>
    </div>
  );
