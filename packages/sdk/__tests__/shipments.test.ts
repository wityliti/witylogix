...
import type { Shipment, ShipmentTracking, PaginatedResponse } from '../src/types';
...
describe('ShipmentsResource', () => {
  ...
  describe('updateStatus', () => {
    it('should update shipment status', async () => {
      const updatedShipment = { ...mockShipment, status: 'out_for_delivery' as const };
      ...
      const result = await shipments.updateStatus('shipment-123', 'out_for_delivery');
