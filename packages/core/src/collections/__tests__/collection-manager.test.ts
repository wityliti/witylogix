...
describe('CollectionManager', () => {
  ...
  describe('syncFromShopify', () => {
    it('should create new collection from Shopify', async () => {
      ...
      const result = await manager.syncFromShopify('shop-1', [shopifyCollection as any]);
  ...
  describe('evaluateAutoRules', () => {
    ...
    it('should throw error when evaluating manual collection rules', async () => {
      ...
      await expect(manager.evaluateAutoRules('col-1')).rejects.toThrow(CollectionError);
    });
  ...
  describe('listCollections', () => {
    it('should list collections with pagination', async () => {
      ...
      const result = await manager.listCollections('shop-1', { limit: 20, offset: 0 });
  ...
  describe('getCollectionByExternalId', () => {
    it('should get collection by external ID', async () => {
      ...
      const result = await manager.getCollectionByExternalId('shop-1', 'shopify-col-1');
    ...
    it('should return null when not found', async () => {
      ...
      const result = await manager.getCollectionByExternalId('shop-1', 'invalid-id');
