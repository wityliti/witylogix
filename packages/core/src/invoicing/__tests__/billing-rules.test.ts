...
describe("BillingRuleEngine", () => {
  ...
  describe("Per-Mile Billing", () => {
    ...
    it("should apply surcharges to per-mile", () => {
      const rule = createBillingRule(
        ...
        {
          unitRate: 2.0,
          surcharges: [{ name: "Congestion", type: "percentage", value: 15 }],
        },
      );
  ...
  describe("Tax Calculation", () => {
    it("should calculate single tax", () => {
      ...
      const taxRules = [
        { rate: 10, description: "Sales Tax", jurisdiction: "CA" },
      ];
  ...
  describe("Combined Rules", () => {
    it("should combine base + per-mile + surcharge", () => {
      const baseRule = createBillingRule(
        "rule_1",
        "tenant_1",
        "Base",
        "per-delivery",
      ...
      const mileRule = createBillingRule(
        "rule_2",
        "tenant_1",
        "Per Mile",
        "per-mile",
  ...
  describe("Real-world Scenarios", () => {
    it("should handle complex delivery pricing", () => {
      ...
      const distanceRule = createBillingRule(
        "rule_dist",
        "tenant_1",
        "Distance",
        "per-mile",
      ...
      const peakRule = createBillingRule(
        "rule_peak",
        "tenant_1",
        "Peak Charge",
        "per-delivery",
      ...
      const items = engine.evaluateRules(peakContext, [
        baseRule,
        distanceRule,
        peakRule,
      ]);
