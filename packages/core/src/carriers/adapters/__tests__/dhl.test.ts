          ...
          products: [
            {
              ...
              basePrice: 20.0,
              totalPrice: 22.5,
              surcharges: [{ type: "Fuel Surcharge", amount: 2.5 }],
            },
            {
              productCode: "N",
              basePrice: 35.0,
          ...
          products: [
            {
              ...
              totalPrice: 65.0,
              surcharges: [
                { type: "Fuel Surcharge", amount: 5.0 },
                { type: "Remote Area Fee", amount: 8.0 },
                { type: "Customs Clearance", amount: 2.0 },
              ],
            },
          ],
          currency: "EUR",
