...
describe("Smart Carrier Selector", () => {
  ...
  describe("Carrier Scoring", () => {
    ...
    it("should rank carriers by overall score", () => {
      ...
      expect(scores[0].overallScore).toBeGreaterThanOrEqual(
        scores[1].overallScore,
      );
      expect(scores[1].overallScore).toBeGreaterThanOrEqual(
        scores[2].overallScore,
      );
    });
    ...
    it("should favor cheapest carrier when cost is prioritized", () => {
      ...
      const scores = scorer.scoreAllCarriers(
        rates,
        "CA-NY",
        undefined,
        weights,
  ...
  describe("Carrier Recommendation", () => {
    ...
    it("should provide alternatives", () => {
      ...
      expect(recommendation.alternatives[0].score).toBeLessThanOrEqual(
