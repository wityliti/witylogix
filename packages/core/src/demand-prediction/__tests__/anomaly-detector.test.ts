...
describe("Anomaly Detection", () => {
  ...
  describe("classifyAnomaly", () => {
    ...
    it("should classify trend-shift", () => {
      ...
      const history = Array(40).fill(50).concat(Array(20).fill(70));
  ...
  describe("calculateSeverity", () => {
    ...
    it("should be between 1 and 10", () => {
      for (let i = 0; i < 10; i++) {
        const severity = calculateSeverity(Math.random() * 100, 50, 5, "spike");
  ...
  describe("calculateControlLimits", () => {
    ...
    it("should have warning limits inside control limits", () => {
      ...
      expect(limits.upper_warning_limit).toBeLessThan(
        limits.upper_control_limit,
      );
      expect(limits.lower_warning_limit).toBeGreaterThan(
