...
describe("NetSuiteClient", () => {
  ...
  describe("Customers", () => {
    it("should create customer", async () => {
      ...
      mockFetch.mockResolvedValueOnce(
        okJson({ id: "cust_123", externalId: "ext_123" }),
      );
    ...
    it("should search customers with SuiteQL", async () => {
      mockFetch.mockResolvedValueOnce(
        okJson({
          items: [
            { id: "cust_1", entityid: "CUST001", email: "test@test.com" },
          ],
          count: 1,
          hasMore: false,
        }),
  ...
  describe("Vendors", () => {
    it("should create vendor", async () => {
      ...
      mockFetch.mockResolvedValueOnce(
        okJson({ id: "vend_123", externalId: "ext_v123" }),
      );
  ...
  describe("Sales Orders", () => {
    it("should create sales order", async () => {
      ...
      mockFetch.mockResolvedValueOnce(
        okJson({ id: "so_123", externalId: "ext_so_123" }),
      );
  ...
  describe("Invoices", () => {
    it("should create sales invoice", async () => {
      ...
      mockFetch.mockResolvedValueOnce(
        okJson({ id: "inv_123", externalId: "ext_inv_123" }),
      );
    ...
    it("should create purchase invoice", async () => {
      ...
      mockFetch.mockResolvedValueOnce(
        okJson({ id: "pinv_123", externalId: "ext_pinv_123" }),
      );
  ...
  describe("Payments", () => {
    it("should create payment", async () => {
      ...
      mockFetch.mockResolvedValueOnce(
        okJson({ id: "pay_123", externalId: "ext_pay_123" }),
      );
  ...
  describe("Items", () => {
    it("should create item", async () => {
      ...
      mockFetch.mockResolvedValueOnce(
        okJson({ id: "item_123", itemCode: "ITEM001" }),
      );
  ...
  describe("File Cabinet", () => {
    it("should upload file", async () => {
      mockFetch.mockResolvedValueOnce(
        okJson({ fileId: "file_123", internalId: "int_123" }),
      );
  ...
  describe("Custom Records", () => {
    ...
    it("should get custom record", async () => {
      ...
      const record = await nsClient.getCustomRecord(
        "customrecord_test",
        "rec_123",
      );
  ...
  describe("Webhook Support", () => {
    ...
    it("should handle webhook payload", async () => {
      ...
      await expect(
        nsClient.handleWebhookPayload(payload),
