...
describe('WebhookSignatureVerifier', () => {
  ...
  describe('Stripe signature verification', () => {
    it('should verify valid Stripe signature', async () => {
      ...
      const verifier = new WebhookSignatureVerifier(config, SignatureFormat.STRIPE);
  ...
  describe('Shopify signature verification', () => {
    it('should verify valid Shopify signature', async () => {
      ...
      const verifier = new WebhookSignatureVerifier(config, SignatureFormat.SHOPIFY);
      const result = await verifier.verify(payload, {
  ...
  describe('EasyPost signature verification', () => {
    it('should verify valid EasyPost signature', async () => {
      ...
      const verifier = new WebhookSignatureVerifier(config, SignatureFormat.EASYPOST);
      const result = await verifier.verify(payload, {
  ...
  describe('Generic signature verification', () => {
    it('should verify valid generic signature', async () => {
      ...
      const verifier = new WebhookSignatureVerifier(config, SignatureFormat.GENERIC_SIGNATURE);
      const result = await verifier.verify(payload, {
  ...
  describe('Replay protection', () => {
    it('should reject duplicate nonce', async () => {
      ...
      const result1 = await verifier.verify(payload, { 'x-signature': signature }, nonce);
      expect(result1.valid).toBe(true);

      // Second request with same nonce should fail
      const result2 = await verifier.verify(payload, { 'x-signature': signature }, nonce);
    ...
    it('should allow nonce replay protection to be disabled', async () => {
      ...
      const verifier = new WebhookSignatureVerifier(configNoReplay, SignatureFormat.GENERIC_SIGNATURE);
