...
describe('GoogleMapsService', () => {
  ...
  describe('constructor', () => {
    it('should throw if API key is missing', () => {
      expect(() => new GoogleMapsService('')).toThrow('Google Maps API key is required');
    });
  ...
  describe('clearCache', () => {
    it('should clear the cache', () => {
      ...
      expect(mapsService.getRateLimitInfo().remaining).toBe(mapsService.getRateLimitInfo().limit);
    });
  });
});
