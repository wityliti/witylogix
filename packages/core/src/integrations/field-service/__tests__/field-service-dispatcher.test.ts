...
describe('FieldServiceDispatcher', () => {
  ...
  describe('Dispatch Optimization', () => {
      ...
      const jobs: Job[] = [
        {
          ...
          location: { address: '100 Main St', city: 'Boston', postalCode: '02101', country: 'US', latitude: 42.3601, longitude: -71.0589 },
          status: 'scheduled',
          priority: 'high',
        ...
        },
        {
          ...
          location: { address: '200 Main St', city: 'Boston', postalCode: '02102', country: 'US', latitude: 42.3602, longitude: -71.0590 },
          status: 'scheduled',
          priority: 'medium',
      ...
      const technicians: Technician[] = [
        {
          ...
          currentLocation: { latitude: 42.3600, longitude: -71.0588, timestamp: new Date() },
          rating: 4.5,
        },
        {
          id: 'tech-2',
          ...
          status: 'available',
          skills: ['Plumbing', 'Gas'],
          currentLocation: { latitude: 42.3603, longitude: -71.0591, timestamp: new Date() },
          rating: 4.8,
        },
      ];
      ...
      const jobs: Job[] = [
        {
          ...
          location: { address: '100 Main St', city: 'Boston', postalCode: '02101', country: 'US' },
          status: 'scheduled',
          priority: 'high',
    ...
    it('should optimize for travel time minimization', async () => {
      const jobs: Job[] = [
        ...
        },
        {
          ...
          customerId: 'CUST002',
          title: 'Service 2',
          location: { address: '150 Main St', city: 'Boston', postalCode: '02101', country: 'US', latitude: 42.3605, longitude: -71.0595 },
          status: 'scheduled',
          priority: 'medium',
          duration: 60,
        },
    ...
    it('should optimize for workload balancing', async () => {
      ...
      const technicians: Technician[] = [
        { id: 'tech-1', firstName: 'John', lastName: 'Doe', status: 'available' },
        { id: 'tech-2', firstName: 'Jane', lastName: 'Smith', status: 'available' },
        { id: 'tech-3', firstName: 'Bob', lastName: 'Johnson', status: 'available' },
      ];
  ...
  describe('SLA Compliance', () => {
    it('should calculate SLA compliance for assignments', () => {
      ...
      const result = dispatcher.calculateSLACompliance(assignment, job, targetCompletionTime);
    ...
    it('should find nearest available technician', async () => {
      ...
      const technicians: Technician[] = [
        ...
        },
        {
          ...
          lastName: 'Smith',
          status: 'available',
          currentLocation: { latitude: 42.4000, longitude: -71.1000, timestamp: new Date() },
        },
      ];
  ...
  describe('Territory Coverage', () => {
    it('should check territory coverage', async () => {
      ...
      const result = await dispatcher.checkTerritoryCoverage(territory, technicians);
  ...
  describe('Constraints Handling', () => {
    it('should respect max jobs per technician constraint', async () => {
      ...
      const result = await dispatcher.optimizeDispatch(request);
      const assignedToTech1 = result.assignments.filter((a) => a.technicianId === 'tech-1').length;
