...
import type { AnalyticsConfig, QueryDefinition, DashboardDefinition } from '../types.js';
...
describe('TableauClient', () => {
  ...
  describe('Workbook Operations', () => {
    ...
    it('should throw error when workbook not found', async () => {
      ...
      await expect(client.getWorkbook('invalid-id')).rejects.toThrow('Failed to fetch workbook');
    });
    ...
    it('should publish workbook successfully', async () => {
      ...
      const published = await client.publishWorkbook('New Workbook', '/path/to/file.twbx', 'proj-1');
  ...
  describe('Subscriptions', () => {
    ...
    it('should create subscription', async () => {
      ...
      const subscription = await client.createSubscription('view-1', 'user-1', 'daily');
