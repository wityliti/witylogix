  ...
  private ruleMatches(rule: Rule, context: Context): boolean {
    ...
    if (rule.matchMode === "all") {
      ...
      return (
        ...
        this.evaluateCondition(rule.conditions[0], context)
      );
    }
  }
  ...
  describe("Operators - Equality", () => {
    it("should evaluate eq operator correctly", () => {
      const rule: Rule = {
        ...
        priority: 1,
        conditions: [
          { field: "destination", operator: "eq", value: "manhattan" },
        ],
        matchMode: "all",
    ...
    it("should fail eq when values do not match", () => {
      const rule: Rule = {
        ...
        priority: 1,
        conditions: [
          { field: "destination", operator: "eq", value: "brooklyn" },
        ],
        matchMode: "all",
    ...
    it("should evaluate neq operator correctly", () => {
      const rule: Rule = {
        ...
        priority: 1,
        conditions: [
          { field: "destination", operator: "neq", value: "brooklyn" },
        ],
        matchMode: "all",
        action: { type: "shipping_method", payload: {} },
        active: true,
        ...
        conditions: [
          {
            field: "destination",
            operator: "in",
            value: ["manhattan", "brooklyn", "queens"],
          },
        ],
        matchMode: "all",
        action: { type: "shipping_method", payload: {} },
  ...
  describe("Edge Cases", () => {
    ...
    it("should handle context with missing fields", () => {
      const rule: Rule = {
        ...
        priority: 1,
        conditions: [
          { field: "unknownField", operator: "eq", value: "something" },
        ],
        matchMode: "all",
        action: { type: "shipping_method", payload: {} },
        active: true,
