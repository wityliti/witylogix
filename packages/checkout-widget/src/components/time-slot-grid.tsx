  ...
  if (sortedSlots.length === 0) {
    return (
      <div className="wl-w-full wl-text-center wl-py-8">
        ...
        <p className="wl-text-wl-muted-foreground">
    ...
    <div className={clsx("wl-space-y-3", { "wl-max-w-md": compact })}>
          ...
          return (
            <button
              ...
              className={clsx(
                ...
                {
                  "wl-border-wl-accent wl-bg-wl-accent/5 wl-shadow-md":
                    isSelected,
            ...
            >
              ...
              <div
                className={clsx(
                  "wl-inline-block wl-px-3 wl-py-1 wl-rounded wl-text-xs wl-font-medium wl-border",
                  statusColor,
                )}
              >
                {getAvailableSlotsText(
              ...
              {isSelected && (
                <div className="wl-absolute wl-right-4 wl-top-4">
                  <div className="wl-w-5 wl-h-5 wl-rounded-full wl-bg-wl-accent wl-flex wl-items-center wl-justify-center">
                    <svg
                      className="wl-w-3 wl-h-3 wl-text-white"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                      <path
      ...
      <div className="wl-mt-6 wl-p-4 wl-bg-wl-muted/30 wl-rounded-lg wl-text-sm wl-text-wl-muted-foreground">
        <div className="wl-flex wl-gap-2">
          ...
          <div>
            <p className="wl-font-medium wl-text-wl-foreground wl-mb-1">
              Slot times may vary
            </p>
            <p>
              Actual delivery will be within the selected window. Driver will
              contact you to confirm arrival time.
            </p>
          </div>
        </div>
      </div>
