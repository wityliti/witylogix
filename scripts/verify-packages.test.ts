...
describe("Package Verification", () => {
  ...
  describe("Package Configuration", () => {
    it("required packages should have main field", () => {
      for (const pkg of REQUIRED_PACKAGES) {
        const packageJson = readPackageJson(pkg);
        expect(packageJson.main, `${pkg} should have main field`).toBeDefined();
      }
    });
  ...
  describe("Package Metadata", () => {
    it("all packages should be private", () => {
      for (const pkg of PACKAGES) {
        const packageJson = readPackageJson(pkg);
        expect(packageJson.private, `${pkg} should be marked as private`).toBe(
          true,
        );
      }
    });
  ...
  describe("Export Entry Points", () => {
    it("framework should export all submodules", () => {
      ...
      expect(
        exports["./workflow"],
        "framework should export ./workflow",
      ).toBeDefined();
      expect(
        exports["./container"],
        "framework should export ./container",
      ).toBeDefined();
      expect(
        exports["./types"],
        "framework should export ./types",
      ).toBeDefined();
      expect(
        exports["./queue"],
        "framework should export ./queue",
      ).toBeDefined();
    });
    ...
    it("workflows should export steps and definitions", () => {
      ...
      expect(
        exports["./steps"],
        "workflows should export ./steps",
      ).toBeDefined();
      expect(
        exports["./definitions"],
        "workflows should export ./definitions",
      ).toBeDefined();
    });
  });
});
